 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(P,X){var H=P.length;P.push(X);e:for(;0<H;){var U=H-1>>>1,k=P[U];if(0<r(k,X))P[U]=X,P[H]=k,H=U;else break e}}function n(P){return P.length===0?null:P[0]}function i(P){if(P.length===0)return null;var X=P[0],H=P.pop();if(H!==X){P[0]=H;e:for(var U=0,k=P.length,se=k>>>1;U<se;){var oe=2*(U+1)-1,ue=P[oe],pe=oe+1,Se=P[pe];if(0>r(ue,H))pe<k&&0>r(Se,ue)?(P[U]=Se,P[pe]=H,U=pe):(P[U]=ue,P[oe]=H,U=oe);else if(pe<k&&0>r(Se,H))P[U]=Se,P[pe]=H,U=pe;else break e}}return X}function r(P,X){var H=P.sortIndex-X.sortIndex;return H!==0?H:P.id-X.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],f=1,h=null,d=3,m=!1,x=!1,v=!1,p=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,_=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(P){for(var X=n(u);X!==null;){if(X.callback===null)i(u);else if(X.startTime<=P)i(u),X.sortIndex=X.expirationTime,e(l,X);else break;X=n(u)}}function S(P){if(v=!1,g(P),!x)if(n(l)!==null)x=!0,K(T);else{var X=n(u);X!==null&&B(S,X.startTime-P)}}function T(P,X){x=!1,v&&(v=!1,c(b),b=-1),m=!0;var H=d;try{for(g(X),h=n(l);h!==null&&(!(h.expirationTime>X)||P&&!N());){var U=h.callback;if(typeof U=="function"){h.callback=null,d=h.priorityLevel;var k=U(h.expirationTime<=X);X=t.unstable_now(),typeof k=="function"?h.callback=k:h===n(l)&&i(l),g(X)}else i(l);h=n(l)}if(h!==null)var se=!0;else{var oe=n(u);oe!==null&&B(S,oe.startTime-X),se=!1}return se}finally{h=null,d=H,m=!1}}var C=!1,R=null,b=-1,M=5,w=-1;function N(){return!(t.unstable_now()-w<M)}function Z(){if(R!==null){var P=t.unstable_now();w=P;var X=!0;try{X=R(!0,P)}finally{X?D():(C=!1,R=null)}}else C=!1}var D;if(typeof _=="function")D=function(){_(Z)};else if(typeof MessageChannel<"u"){var z=new MessageChannel,W=z.port2;z.port1.onmessage=Z,D=function(){W.postMessage(null)}}else D=function(){p(Z,0)};function K(P){R=P,C||(C=!0,D())}function B(P,X){b=p(function(){P(t.unstable_now())},X)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(P){P.callback=null},t.unstable_continueExecution=function(){x||m||(x=!0,K(T))},t.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):M=0<P?Math.floor(1e3/P):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(P){switch(d){case 1:case 2:case 3:var X=3;break;default:X=d}var H=d;d=X;try{return P()}finally{d=H}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(P,X){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var H=d;d=P;try{return X()}finally{d=H}},t.unstable_scheduleCallback=function(P,X,H){var U=t.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?U+H:U):H=U,P){case 1:var k=-1;break;case 2:k=250;break;case 5:k=1073741823;break;case 4:k=1e4;break;default:k=5e3}return k=H+k,P={id:f++,callback:X,priorityLevel:P,startTime:H,expirationTime:k,sortIndex:-1},H>U?(P.sortIndex=H,e(u,P),n(l)===null&&P===n(u)&&(v?(c(b),b=-1):v=!0,B(S,H-U))):(P.sortIndex=k,e(l,P),x||m||(x=!0,K(T))),P},t.unstable_shouldYield=N,t.unstable_wrapCallback=function(P){var X=d;return function(){var H=d;d=X;try{return P.apply(this,arguments)}finally{d=H}}}})(Up);Dp.exports=Up;var G_=Dp.exports;/**
 * @license React
...
}`;function BT(t,e,n){let i=new Rf;const r=new He,s=new He,o=new yt,a=new FT({depthPacking:bx}),l=new OT,u={},f=n.maxTextureSize,h={[ki]:Qt,[Qt]:ki,[ti]:ti},d=new gr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new He},radius:{value:4}},vertexShader:zT,fragmentShader:kT}),m=d.clone();m.defines.HORIZONTAL_PASS=1;const x=new xr;x.setAttribute("position",new Vn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new si(x,d),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Ng;let c=this.type;this.render=function(T,C,R){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||T.length===0)return;const b=t.getRenderTarget(),M=t.getActiveCubeFace(),w=t.getActiveMipmapLevel(),N=t.state;N.setBlending(Ii),N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const Z=c!==Qn&&this.type===Qn,D=c===Qn&&this.type!==Qn;for(let z=0,W=T.length;z<W;z++){const K=T[z],B=K.shadow;if(B===void 0){console.warn("THREE.WebGLShadowMap:",K,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;r.copy(B.mapSize);const P=B.getFrameExtents();if(r.multiply(P),s.copy(B.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/P.x),r.x=s.x*P.x,B.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/P.y),r.y=s.y*P.y,B.mapSize.y=s.y)),B.map===null||Z===!0||D===!0){const H=this.type!==Qn?{minFilter:Bt,magFilter:Bt}:{};B.map!==null&&B.map.dispose(),B.map=new mr(r.x,r.y,H),B.map.texture.name=K.name+".shadowMap",B.camera.updateProjectionMatrix()}t.setRenderTarget(B.map),t.clear();const X=B.getViewportCount();for(let H=0;H<X;H++){const U=B.getViewport(H);o.set(s.x*U.x,s.y*U.y,s.x*U.z,s.y*U.w),N.viewport(o),B.updateMatrices(K,H),i=B.getFrustum(),S(C,R,B.camera,K,this.type)}B.isPointLightShadow!==!0&&this.type===Qn&&_(B,R),B.needsUpdate=!1}c=this.type,p.needsUpdate=!1,t.setRenderTarget(b,M,w)};function _(T,C){const R=e.update(v);d.defines.VSM_SAMPLES!==T.blurSamples&&(d.defines.VSM_SAMPLES=T.blurSamples,m.defines.VSM_SAMPLES=T.blurSamples,d.needsUpdate=!0,m.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new mr(r.x,r.y)),d.uniforms.shadow_pass.value=T.map.texture,d.uniforms.resolution.value=T.mapSize,d.uniforms.radius.value=T.radius,t.setRenderTarget(T.mapPass),t.clear(),t.renderBufferDirect(C,null,R,d,v,null),m.uniforms.shadow_pass.value=T.mapPass.texture,m.uniforms.resolution.value=T.mapSize,m.uniforms.radius.value=T.radius,t.setRenderTarget(T.map),t.clear(),t.renderBufferDirect(C,null,R,m,v,null)}function g(T,C,R,b){let M=null;const w=R.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if(w!==void 0)M=w;else if(M=R.isPointLight===!0?l:a,t.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0){const N=M.uuid,Z=C.uuid;let D=u[N];D===void 0&&(D={},u[N]=D);let z=D[Z];z===void 0&&(z=M.clone(),D[Z]=z),M=z}if(M.visible=C.visible,M.wireframe=C.wireframe,b===Qn?M.side=C.shadowSide!==null?C.shadowSide:C.side:M.side=C.shadowSide!==null?C.shadowSide:h[C.side],M.alphaMap=C.alphaMap,M.alphaTest=C.alphaTest,M.map=C.map,M.clipShadows=C.clipShadows,M.clippingPlanes=C.clippingPlanes,M.clipIntersection=C.clipIntersection,M.displacementMap=C.displacementMap,M.displacementScale=C.displacementScale,M.displacementBias=C.displacementBias,M.wireframeLinewidth=C.wireframeLinewidth,M.linewidth=C.linewidth,R.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const N=t.properties.get(M);N.light=R}return M}function S(T,C,R,b,M){if(T.visible===!1)return;if(T.layers.test(C.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&M===Qn)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,T.matrixWorld);const Z=e.update(T),D=T.material;if(Array.isArray(D)){const z=Z.groups;for(let W=0,K=z.length;W<K;W++){const B=z[W],P=D[B.materialIndex];if(P&&P.visible){const X=g(T,P,b,M);t.renderBufferDirect(R,null,Z,X,T,B)}}}else if(D.visible){const z=g(T,D,b,M);t.renderBufferDirect(R,null,Z,z,T,null)}}const N=T.children;for(let Z=0,D=N.length;Z<D;Z++)S(N[Z],C,R,b,M)}}function HT(t,e,n){const i=n.isWebGL2;function r(){let L=!1;const ae=new yt;let j=null;const ie=new yt(0,0,0,0);return{setMask:function(le){j!==le&&!L&&(t.colorMask(le,le,le,le),j=le)},setLocked:function(le){L=le},setClear:function(le,ke,et,lt,di){di===!0&&(le*=lt,ke*=lt,et*=lt),ae.set(le,ke,et,lt),ie.equals(ae)===!1&&(t.clearColor(le,ke,et,lt),ie.copy(ae))},reset:function(){L=!1,j=null,ie.set(-1,0,0,0)}}}function s(){let L=!1,ae=null,j=null,ie=null;return{setTest:function(le){le?Se(t.DEPTH_TEST):ye(t.DEPTH_TEST)},setMask:function(le){ae!==le&&!L&&(t.depthMask(le),ae=le)},setFunc:function(le){if(j!==le){switch(le){case ox:t.depthFunc(t.NEVER);break;case ax:t.depthFunc(t.ALWAYS);break;case lx:t.depthFunc(t.LESS);break;case vc:t.depthFunc(t.LEQUAL);break;case ux:t.depthFunc(t.EQUAL);break;case cx:t.depthFunc(t.GEQUAL);break;case fx:t.depthFunc(t.GREATER);break;case dx:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}j=le}},setLocked:function(le){L=le},setClear:function(le){ie!==le&&(t.clearDepth(le),ie=le)},reset:function(){L=!1,ae=null,j=null,ie=null}}}function o(){let L=!1,ae=null,j=null,ie=null,le=null,ke=null,et=null,lt=null,di=null;return{setTest:function(qe){L||(qe?Se(t.STENCIL_TEST):ye(t.STENCIL_TEST))},setMask:function(qe){ae!==qe&&!L&&(t.stencilMask(qe),ae=qe)},setFunc:function(qe,Fn,Ft){(j!==qe||ie!==Fn||le!==Ft)&&(t.stencilFunc(qe,Fn,Ft),j=qe,ie=Fn,le=Ft)},setOp:function(qe,Fn,Ft){(ke!==qe||et!==Fn||lt!==Ft)&&(t.stencilOp(qe,Fn,Ft),ke=qe,et=Fn,lt=Ft)},setLocked:function(qe){L=qe},setClear:function(qe){di!==qe&&(t.clearStencil(qe),di=qe)},reset:function(){L=!1,ae=null,j=null,ie=null,le=null,ke=null,et=null,lt=null,di=null}}}const a=new r,l=new s,u=new o,f=new WeakMap,h=new WeakMap;let d={},m={},x=new WeakMap,v=[],p=null,c=!1,_=null,g=null,S=null,T=null,C=null,R=null,b=null,M=!1,w=null,N=null,Z=null,D=null,z=null;const W=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,B=0;const P=t.getParameter(t.VERSION);P.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(P)[1]),K=B>=1):P.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(P)[1]),K=B>=2);let X=null,H={};const U=t.getParameter(t.SCISSOR_BOX),k=t.getParameter(t.VIEWPORT),se=new yt().fromArray(U),oe=new yt().fromArray(k);function ue(L,ae,j,ie){const le=new Uint8Array(4),ke=t.createTexture();t.bindTexture(L,ke),t.texParameteri(L,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(L,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let et=0;et<j;et++)i&&(L===t.TEXTURE_3D||L===t.TEXTURE_2D_ARRAY)?t.texImage3D(ae,0,t.RGBA,1,1,ie,0,t.RGBA,t.UNSIGNED_BYTE,le):t.texImage2D(ae+et,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,le);return ke}const pe={};pe[t.TEXTURE_2D]=ue(t.TEXTURE_2D,t.TEXTURE_2D,1),pe[t.TEXTURE_CUBE_MAP]=ue(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),i&&(pe[t.TEXTURE_2D_ARRAY]=ue(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),pe[t.TEXTURE_3D]=ue(t.TEXTURE_3D,t.TEXTURE_3D,1,1)),a.setClear(0,0,0,1),l.setClear(1),u.setClear(0),Se(t.DEPTH_TEST),l.setFunc(vc),Ae(!1),Je(jd),Se(t.CULL_FACE),Me(Ii);function Se(L){d[L]!==!0&&(t.enable(L),d[L]=!0)}function ye(L){d[L]!==!1&&(t.disable(L),d[L]=!1)}function Ge(L,ae){return m[L]!==ae?(t.bindFramebuffer(L,ae),m[L]=ae,i&&(L===t.DRAW_FRAMEBUFFER&&(m[t.FRAMEBUFFER]=ae),L===t.FRAMEBUFFER&&(m[t.DRAW_FRAMEBUFFER]=ae)),!0):!1}function Wt(L,ae){let j=v,ie=!1;if(L)if(j=x.get(ae),j===void 0&&(j=[],x.set(ae,j)),L.isWebGLMultipleRenderTargets){const le=L.texture;if(j.length!==le.length||j[0]!==t.COLOR_ATTACHMENT0){for(let ke=0,et=le.length;ke<et;ke++)j[ke]=t.COLOR_ATTACHMENT0+ke;j.length=le.length,ie=!0}}else j[0]!==t.COLOR_ATTACHMENT0&&(j[0]=t.COLOR_ATTACHMENT0,ie=!0);else j[0]!==t.BACK&&(j[0]=t.BACK,ie=!0);ie&&(n.isWebGL2?t.drawBuffers(j):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(j))}function Pe(L){return p!==L?(t.useProgram(L),p=L,!0):!1}const F={[Or]:t.FUNC_ADD,[$0]:t.FUNC_SUBTRACT,[K0]:t.FUNC_REVERSE_SUBTRACT};if(i)F[Kd]=t.MIN,F[Zd]=t.MAX;else{const L=e.get("EXT_blend_minmax");L!==null&&(F[Kd]=L.MIN_EXT,F[Zd]=L.MAX_EXT)}const Rt={[Z0]:t.ZERO,[Q0]:t.ONE,[J0]:t.SRC_COLOR,[Fg]:t.SRC_ALPHA,[sx]:t.SRC_ALPHA_SATURATE,[ix]:t.DST_COLOR,[tx]:t.DST_ALPHA,[ex]:t.ONE_MINUS_SRC_COLOR,[Og]:t.ONE_MINUS_SRC_ALPHA,[rx]:t.ONE_MINUS_DST_COLOR,[nx]:t.ONE_MINUS_DST_ALPHA};function Me(L,ae,j,ie,le,ke,et,lt){if(L===Ii){c===!0&&(ye(t.BLEND),c=!1);return}if(c===!1&&(Se(t.BLEND),c=!0),L!==q0){if(L!==_||lt!==M){if((g!==Or||C!==Or)&&(t.blendEquation(t.FUNC_ADD),g=Or,C=Or),lt)switch(L){case is:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Yd:t.blendFunc(t.ONE,t.ONE);break;case qd:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case $d:t.blendFuncSeparate(t.ZERO,t.SRC_COLOR,t.ZERO,t.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case is:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Yd:t.blendFunc(t.SRC_ALPHA,t.ONE);break;case qd:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case $d:t.blendFunc(t.ZERO,t.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}S=null,T=null,R=null,b=null,_=L,M=lt}return}le=le||ae,ke=ke||j,et=et||ie,(ae!==g||le!==C)&&(t.blendEquationSeparate(F[ae],F[le]),g=ae,C=le),(j!==S||ie!==T||ke!==R||et!==b)&&(t.blendFuncSeparate(Rt[j],Rt[ie],Rt[ke],Rt[et]),S=j,T=ie,R=ke,b=et),_=L,M=!1}function Re(L,ae){L.side===ti?ye(t.CULL_FACE):Se(t.CULL_FACE);let j=L.side===Qt;ae&&(j=!j),Ae(j),L.blending===is&&L.transparent===!1?Me(Ii):Me(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.premultipliedAlpha),l.setFunc(L.depthFunc),l.setTest(L.depthTest),l.setMask(L.depthWrite),a.setMask(L.colorWrite);const ie=L.stencilWrite;u.setTest(ie),ie&&(u.setMask(L.stencilWriteMask),u.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),u.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),be(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Se(t.SAMPLE_ALPHA_TO_COVERAGE):ye(t.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(L){w!==L&&(L?t.frontFace(t.CW):t.frontFace(t.CCW),w=L)}function Je(L){L!==X0?(Se(t.CULL_FACE),L!==N&&(L===jd?t.cullFace(t.BACK):L===j0?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):ye(t.CULL_FACE),N=L}function Oe(L){L!==Z&&(K&&t.lineWidth(L),Z=L)}function be(L,ae,j){L?(Se(t.POLYGON_OFFSET_FILL),(D!==ae||z!==j)&&(t.polygonOffset(ae,j),D=ae,z=j)):ye(t.POLYGON_OFFSET_FILL)}function Xe(L){L?Se(t.SCISSOR_TEST):ye(t.SCISSOR_TEST)}function Et(L){L===void 0&&(L=t.TEXTURE0+W-1),X!==L&&(t.activeTexture(L),X=L)}function Ct(L,ae,j){j===void 0&&(X===null?j=t.TEXTURE0+W-1:j=X);let ie=H[j];ie===void 0&&(ie={type:void 0,texture:void 0},H[j]=ie),(ie.type!==L||ie.texture!==ae)&&(X!==j&&(t.activeTexture(j),X=j),t.bindTexture(L,ae||pe[L]),ie.type=L,ie.texture=ae)}function A(){const L=H[X];L!==void 0&&L.type!==void 0&&(t.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function y(){try{t.compressedTexImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function G(){try{t.compressedTexImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ee(){try{t.texSubImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function J(){try{t.texSubImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function te(){try{t.compressedTexSubImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function me(){try{t.compressedTexSubImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ne(){try{t.texStorage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Y(){try{t.texStorage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ve(){try{t.texImage2D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ge(){try{t.texImage3D.apply(t,arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function _e(L){se.equals(L)===!1&&(t.scissor(L.x,L.y,L.z,L.w),se.copy(L))}function de(L){oe.equals(L)===!1&&(t.viewport(L.x,L.y,L.z,L.w),oe.copy(L))}function he(L,ae){let j=h.get(ae);j===void 0&&(j=new WeakMap,h.set(ae,j));let ie=j.get(L);ie===void 0&&(ie=t.getUniformBlockIndex(ae,L.name),j.set(L,ie))}function Ue(L,ae){const ie=h.get(ae).get(L);f.get(ae)!==ie&&(t.uniformBlockBinding(ae,ie,L.__bindingPointIndex),f.set(ae,ie))}function je(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),i===!0&&(t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null)),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),d={},X=null,H={},m={},x=new WeakMap,v=[],p=null,c=!1,_=null,g=null,S=null,T=null,C=null,R=null,b=null,M=!1,w=null,N=null,Z=null,D=null,z=null,se.set(0,0,t.canvas.width,t.canvas.height),oe.set(0,0,t.canvas.width,t.canvas.height),a.reset(),l.reset(),u.reset()}return{buffers:{color:a,depth:l,stencil:u},enable:Se,disable:ye,bindFramebuffer:Ge,drawBuffers:Wt,useProgram:Pe,setBlending:Me,setMaterial:Re,setFlipSided:Ae,setCullFace:Je,setLineWidth:Oe,setPolygonOffset:be,setScissorTest:Xe,activeTexture:Et,bindTexture:Ct,unbindTexture:A,compressedTexImage2D:y,compressedTexImage3D:G,texImage2D:ve,texImage3D:ge,updateUBOMapping:he,uniformBlockBinding:Ue,texStorage2D:ne,texStorage3D:Y,texSubImage2D:ee,texSubImage3D:J,compressedTexSubImage2D:te,compressedTexSubImage3D:me,scissor:_e,viewport:de,reset:je}}function GT(t,e,n,i,r,s,o){const a=r.isWebGL2,l=r.maxTextures,u=r.maxCubemapSize,f=r.maxTextureSize,h=r.maxSamples,d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),x=new WeakMap;let v;const p=new WeakMap;let c=!1;try{c=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(A,y){return c?new OffscreenCanvas(A,y):Ka("canvas")}function g(A,y,G,ee){let J=1;if((A.width>ee||A.height>ee)&&(J=ee/Math.max(A.width,A.height)),J<1||y===!0)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap){const te=y?wc:Math.floor,me=te(J*A.width),ne=te(J*A.height);v===void 0&&(v=_(me,ne));const Y=G?_(me,ne):v;return Y.width=me,Y.height=ne,Y.getContext("2d").drawImage(A,0,0,me,ne),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+A.width+"x"+A.height+") to ("+me+"x"+ne+")."),Y}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+A.width+"x"+A.height+")."),A;return A}function S(A){return Ah(A.width)&&Ah(A.height)}function T(A){return a?!1:A.wrapS!==bn||A.wrapT!==bn||A.minFilter!==Bt&&A.minFilter!==mn}function C(A,y){return A.generateMipmaps&&y&&A.minFilter!==Bt&&A.minFilter!==mn}function R(A){t.generateMipmap(A)}function b(A,y,G,ee,J=!1){if(a===!1)return y;if(A!==null){if(t[A]!==void 0)return t[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let te=y;return y===t.RED&&(G===t.FLOAT&&(te=t.R32F),G===t.HALF_FLOAT&&(te=t.R16F),G===t.UNSIGNED_BYTE&&(te=t.R8)),y===t.RED_INTEGER&&(G===t.UNSIGNED_BYTE&&(te=t.R8UI),G===t.UNSIGNED_SHORT&&(te=t.R16UI),G===t.UNSIGNED_INT&&(te=t.R32UI),G===t.BYTE&&(te=t.R8I),G===t.SHORT&&(te=t.R16I),G===t.INT&&(te=t.R32I)),y===t.RG&&(G===t.FLOAT&&(te=t.RG32F),G===t.HALF_FLOAT&&(te=t.RG16F),G===t.UNSIGNED_BYTE&&(te=t.RG8)),y===t.RGBA&&(G===t.FLOAT&&(te=t.RGBA32F),G===t.HALF_FLOAT&&(te=t.RGBA16F),G===t.UNSIGNED_BYTE&&(te=ee===Ze&&J===!1?t.SRGB8_ALPHA8:t.RGBA8),G===t.UNSIGNED_SHORT_4_4_4_4&&(te=t.RGBA4),G===t.UNSIGNED_SHORT_5_5_5_1&&(te=t.RGB5_A1)),(te===t.R16F||te===t.R32F||te===t.RG16F||te===t.RG32F||te===t.RGBA16F||te===t.RGBA32F)&&e.get("EXT_color_buffer_float"),te}function M(A,y,G){return C(A,G)===!0||A.isFramebufferTexture&&A.minFilter!==Bt&&A.minFilter!==mn?Math.log2(Math.max(y.width,y.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?y.mipmaps.length:1}function w(A){return A===Bt||A===Qd||A===ql?t.NEAREST:t.LINEAR}function N(A){const y=A.target;y.removeEventListener("dispose",N),D(y),y.isVideoTexture&&x.delete(y)}function Z(A){const y=A.target;y.removeEventListener("dispose",Z),W(y)}function D(A){const y=i.get(A);if(y.__webglInit===void 0)return;const G=A.source,ee=p.get(G);if(ee){const J=ee[y.__cacheKey];J.usedTimes--,J.usedTimes===0&&z(A),Object.keys(ee).length===0&&p.delete(G)}i.remove(A)}function z(A){const y=i.get(A);t.deleteTexture(y.__webglTexture);const G=A.source,ee=p.get(G);delete ee[y.__cacheKey],o.memory.textures--}function W(A){const y=A.texture,G=i.get(A),ee=i.get(y);if(ee.__webglTexture!==void 0&&(t.deleteTexture(ee.__webglTexture),o.memory.textures--),A.depthTexture&&A.depthTexture.dispose(),A.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(G.__webglFramebuffer[J]))for(let te=0;te<G.__webglFramebuffer[J].length;te++)t.deleteFramebuffer(G.__webglFramebuffer[J][te]);else t.deleteFramebuffer(G.__webglFramebuffer[J]);G.__webglDepthbuffer&&t.deleteRenderbuffer(G.__webglDepthbuffer[J])}else{if(Array.isArray(G.__webglFramebuffer))for(let J=0;J<G.__webglFramebuffer.length;J++)t.deleteFramebuffer(G.__webglFramebuffer[J]);else t.deleteFramebuffer(G.__webglFramebuffer);if(G.__webglDepthbuffer&&t.deleteRenderbuffer(G.__webglDepthbuffer),G.__webglMultisampledFramebuffer&&t.deleteFramebuffer(G.__webglMultisampledFramebuffer),G.__webglColorRenderbuffer)for(let J=0;J<G.__webglColorRenderbuffer.length;J++)G.__webglColorRenderbuffer[J]&&t.deleteRenderbuffer(G.__webglColorRenderbuffer[J]);G.__webglDepthRenderbuffer&&t.deleteRenderbuffer(G.__webglDepthRenderbuffer)}if(A.isWebGLMultipleRenderTargets)for(let J=0,te=y.length;J<te;J++){const me=i.get(y[J]);me.__webglTexture&&(t.deleteTexture(me.__webglTexture),o.memory.textures--),i.remove(y[J])}i.remove(y),i.remove(A)}let K=0;function B(){K=0}function P(){const A=K;return A>=l&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+l),K+=1,A}function X(A){const y=[];return y.push(A.wrapS),y.push(A.wrapT),y.push(A.wrapR||0),y.push(A.magFilter),y.push(A.minFilter),y.push(A.anisotropy),y.push(A.internalFormat),y.push(A.format),y.push(A.type),y.push(A.generateMipmaps),y.push(A.premultiplyAlpha),y.push(A.flipY),y.push(A.unpackAlignment),y.push(A.colorSpace),y.join()}function H(A,y){const G=i.get(A);if(A.isVideoTexture&&Et(A),A.isRenderTargetTexture===!1&&A.version>0&&G.__version!==A.version){const ee=A.image;if(ee===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Ge(G,A,y);return}}n.bindTexture(t.TEXTURE_2D,G.__webglTexture,t.TEXTURE0+y)}function U(A,y){const G=i.get(A);if(A.version>0&&G.__version!==A.version){Ge(G,A,y);return}n.bindTexture(t.TEXTURE_2D_ARRAY,G.__webglTexture,t.TEXTURE0+y)}function k(A,y){const G=i.get(A);if(A.version>0&&G.__version!==A.version){Ge(G,A,y);return}n.bindTexture(t.TEXTURE_3D,G.__webglTexture,t.TEXTURE0+y)}function se(A,y){const G=i.get(A);if(A.version>0&&G.__version!==A.version){Wt(G,A,y);return}n.bindTexture(t.TEXTURE_CUBE_MAP,G.__webglTexture,t.TEXTURE0+y)}const oe={[yc]:t.REPEAT,[bn]:t.CLAMP_TO_EDGE,[Mc]:t.MIRRORED_REPEAT},ue={[Bt]:t.NEAREST,[Qd]:t.NEAREST_MIPMAP_NEAREST,[ql]:t.NEAREST_MIPMAP_LINEAR,[mn]:t.LINEAR,[Sx]:t.LINEAR_MIPMAP_NEAREST,[po]:t.LINEAR_MIPMAP_LINEAR},pe={[Ix]:t.NEVER,[Hx]:t.ALWAYS,[Nx]:t.LESS,[Ox]:t.LEQUAL,[Fx]:t.EQUAL,[Bx]:t.GEQUAL,[zx]:t.GREATER,[kx]:t.NOTEQUAL};function Se(A,y,G){if(G?(t.texParameteri(A,t.TEXTURE_WRAP_S,oe[y.wrapS]),t.texParameteri(A,t.TEXTURE_WRAP_T,oe[y.wrapT]),(A===t.TEXTURE_3D||A===t.TEXTURE_2D_ARRAY)&&t.texParameteri(A,t.TEXTURE_WRAP_R,oe[y.wrapR]),t.texParameteri(A,t.TEXTURE_MAG_FILTER,ue[y.magFilter]),t.texParameteri(A,t.TEXTURE_MIN_FILTER,ue[y.minFilter])):(t.texParameteri(A,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(A,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE),(A===t.TEXTURE_3D||A===t.TEXTURE_2D_ARRAY)&&t.texParameteri(A,t.TEXTURE_WRAP_R,t.CLAMP_TO_EDGE),(y.wrapS!==bn||y.wrapT!==bn)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),t.texParameteri(A,t.TEXTURE_MAG_FILTER,w(y.magFilter)),t.texParameteri(A,t.TEXTURE_MIN_FILTER,w(y.minFilter)),y.minFilter!==Bt&&y.minFilter!==mn&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),y.compareFunction&&(t.texParameteri(A,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(A,t.TEXTURE_COMPARE_FUNC,pe[y.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const ee=e.get("EXT_texture_filter_anisotropic");if(y.magFilter===Bt||y.minFilter!==ql&&y.minFilter!==po||y.type===wi&&e.has("OES_texture_float_linear")===!1||a===!1&&y.type===mo&&e.has("OES_texture_half_float_linear")===!1)return;(y.anisotropy>1||i.get(y).__currentAnisotropy)&&(t.texParameterf(A,ee.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(y.anisotropy,r.getMaxAnisotropy())),i.get(y).__currentAnisotropy=y.anisotropy)}}function ye(A,y){let G=!1;A.__webglInit===void 0&&(A.__webglInit=!0,y.addEventListener("dispose",N));const ee=y.source;let J=p.get(ee);J===void 0&&(J={},p.set(ee,J));const te=X(y);if(te!==A.__cacheKey){J[te]===void 0&&(J[te]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,G=!0),J[te].usedTimes++;const me=J[A.__cacheKey];me!==void 0&&(J[A.__cacheKey].usedTimes--,me.usedTimes===0&&z(y)),A.__cacheKey=te,A.__webglTexture=J[te].texture}return G}function Ge(A,y,G){let ee=t.TEXTURE_2D;(y.isDataArrayTexture||y.isCompressedArrayTexture)&&(ee=t.TEXTURE_2D_ARRAY),y.isData3DTexture&&(ee=t.TEXTURE_3D);const J=ye(A,y),te=y.source;n.bindTexture(ee,A.__webglTexture,t.TEXTURE0+G);const me=i.get(te);if(te.version!==me.__version||J===!0){n.activeTexture(t.TEXTURE0+G),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,y.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,y.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.NONE);const ne=T(y)&&S(y.image)===!1;let Y=g(y.image,ne,!1,f);Y=Ct(y,Y);const ve=S(Y)||a,ge=s.convert(y.format,y.colorSpace);let _e=s.convert(y.type),de=b(y.internalFormat,ge,_e,y.colorSpace,y.isVideoTexture);Se(ee,y,ve);let he;const Ue=y.mipmaps,je=a&&y.isVideoTexture!==!0,L=me.__version===void 0||J===!0,ae=M(y,Y,ve);if(y.isDepthTexture)de=t.DEPTH_COMPONENT,a?y.type===wi?de=t.DEPTH_COMPONENT32F:y.type===Ti?de=t.DEPTH_COMPONENT24:y.type===sr?de=t.DEPTH24_STENCIL8:de=t.DEPTH_COMPONENT16:y.type===wi&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),y.format===or&&de===t.DEPTH_COMPONENT&&y.type!==Tf&&y.type!==Ti&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),y.type=Ti,_e=s.convert(y.type)),y.format===ps&&de===t.DEPTH_COMPONENT&&(de=t.DEPTH_STENCIL,y.type!==sr&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),y.type=sr,_e=s.convert(y.type))),L&&(je?n.texStorage2D(t.TEXTURE_2D,1,de,Y.width,Y.height):n.texImage2D(t.TEXTURE_2D,0,de,Y.width,Y.height,0,ge,_e,null));else if(y.isDataTexture)if(Ue.length>0&&ve){je&&L&&n.texStorage2D(t.TEXTURE_2D,ae,de,Ue[0].width,Ue[0].height);for(let j=0,ie=Ue.length;j<ie;j++)he=Ue[j],je?n.texSubImage2D(t.TEXTURE_2D,j,0,0,he.width,he.height,ge,_e,he.data):n.texImage2D(t.TEXTURE_2D,j,de,he.width,he.height,0,ge,_e,he.data);y.generateMipmaps=!1}else je?(L&&n.texStorage2D(t.TEXTURE_2D,ae,de,Y.width,Y.height),n.texSubImage2D(t.TEXTURE_2D,0,0,0,Y.width,Y.height,ge,_e,Y.data)):n.texImage2D(t.TEXTURE_2D,0,de,Y.width,Y.height,0,ge,_e,Y.data);else if(y.isCompressedTexture)if(y.isCompressedArrayTexture){je&&L&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,de,Ue[0].width,Ue[0].height,Y.depth);for(let j=0,ie=Ue.length;j<ie;j++)he=Ue[j],y.format!==Dn?ge!==null?je?n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,Y.depth,ge,he.data,0,0):n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,j,de,he.width,he.height,Y.depth,0,he.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):je?n.texSubImage3D(t.TEXTURE_2D_ARRAY,j,0,0,0,he.width,he.height,Y.depth,ge,_e,he.data):n.texImage3D(t.TEXTURE_2D_ARRAY,j,de,he.width,he.height,Y.depth,0,ge,_e,he.data)}else{je&&L&&n.texStorage2D(t.TEXTURE_2D,ae,de,Ue[0].width,Ue[0].height);for(let j=0,ie=Ue.length;j<ie;j++)he=Ue[j],y.format!==Dn?ge!==null?je?n.compressedTexSubImage2D(t.TEXTURE_2D,j,0,0,he.width,he.height,ge,he.data):n.compressedTexImage2D(t.TEXTURE_2D,j,de,he.width,he.height,0,he.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):je?n.texSubImage2D(t.TEXTURE_2D,j,0,0,he.width,he.height,ge,_e,he.data):n.texImage2D(t.TEXTURE_2D,j,de,he.width,he.height,0,ge,_e,he.data)}else if(y.isDataArrayTexture)je?(L&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ae,de,Y.width,Y.height,Y.depth),n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,Y.width,Y.height,Y.depth,ge,_e,Y.data)):n.texImage3D(t.TEXTURE_2D_ARRAY,0,de,Y.width,Y.height,Y.depth,0,ge,_e,Y.data);else if(y.isData3DTexture)je?(L&&n.texStorage3D(t.TEXTURE_3D,ae,de,Y.width,Y.height,Y.depth),n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,Y.width,Y.height,Y.depth,ge,_e,Y.data)):n.texImage3D(t.TEXTURE_3D,0,de,Y.width,Y.height,Y.depth,0,ge,_e,Y.data);else if(y.isFramebufferTexture){if(L)if(je)n.texStorage2D(t.TEXTURE_2D,ae,de,Y.width,Y.height);else{let j=Y.width,ie=Y.height;for(let le=0;le<ae;le++)n.texImage2D(t.TEXTURE_2D,le,de,j,ie,0,ge,_e,null),j>>=1,ie>>=1}}else if(Ue.length>0&&ve){je&&L&&n.texStorage2D(t.TEXTURE_2D,ae,de,Ue[0].width,Ue[0].height);for(let j=0,ie=Ue.length;j<ie;j++)he=Ue[j],je?n.texSubImage2D(t.TEXTURE_2D,j,0,0,ge,_e,he):n.texImage2D(t.TEXTURE_2D,j,de,ge,_e,he);y.generateMipmaps=!1}else je?(L&&n.texStorage2D(t.TEXTURE_2D,ae,de,Y.width,Y.height),n.texSubImage2D(t.TEXTURE_2D,0,0,0,ge,_e,Y)):n.texImage2D(t.TEXTURE_2D,0,de,ge,_e,Y);C(y,ve)&&R(ee),me.__version=te.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function Wt(A,y,G){if(y.image.length!==6)return;const ee=ye(A,y),J=y.source;n.bindTexture(t.TEXTURE_CUBE_MAP,A.__webglTexture,t.TEXTURE0+G);const te=i.get(J);if(J.version!==te.__version||ee===!0){n.activeTexture(t.TEXTURE0+G),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,y.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,y.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,y.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.NONE);const me=y.isCompressedTexture||y.image[0].isCompressedTexture,ne=y.image[0]&&y.image[0].isDataTexture,Y=[];for(let j=0;j<6;j++)!me&&!ne?Y[j]=g(y.image[j],!1,!0,u):Y[j]=ne?y.image[j].image:y.image[j],Y[j]=Ct(y,Y[j]);const ve=Y[0],ge=S(ve)||a,_e=s.convert(y.format,y.colorSpace),de=s.convert(y.type),he=b(y.internalFormat,_e,de,y.colorSpace),Ue=a&&y.isVideoTexture!==!0,je=te.__version===void 0||ee===!0;let L=M(y,ve,ge);Se(t.TEXTURE_CUBE_MAP,y,ge);let ae;if(me){Ue&&je&&n.texStorage2D(t.TEXTURE_CUBE_MAP,L,he,ve.width,ve.height);for(let j=0;j<6;j++){ae=Y[j].mipmaps;for(let ie=0;ie<ae.length;ie++){const le=ae[ie];y.format!==Dn?_e!==null?Ue?n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,0,0,le.width,le.height,_e,le.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,he,le.width,le.height,0,le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ue?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,0,0,le.width,le.height,_e,de,le.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie,he,le.width,le.height,0,_e,de,le.data)}}}else{ae=y.mipmaps,Ue&&je&&(ae.length>0&&L++,n.texStorage2D(t.TEXTURE_CUBE_MAP,L,he,Y[0].width,Y[0].height));for(let j=0;j<6;j++)if(ne){Ue?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Y[j].width,Y[j].height,_e,de,Y[j].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,he,Y[j].width,Y[j].height,0,_e,de,Y[j].data);for(let ie=0;ie<ae.length;ie++){const ke=ae[ie].image[j].image;Ue?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,0,0,ke.width,ke.height,_e,de,ke.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,he,ke.width,ke.height,0,_e,de,ke.data)}}else{Ue?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,_e,de,Y[j]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,he,_e,de,Y[j]);for(let ie=0;ie<ae.length;ie++){const le=ae[ie];Ue?n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,0,0,_e,de,le.image[j]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+j,ie+1,he,_e,de,le.image[j])}}}C(y,ge)&&R(t.TEXTURE_CUBE_MAP),te.__version=J.version,y.onUpdate&&y.onUpdate(y)}A.__version=y.version}function Pe(A,y,G,ee,J,te){const me=s.convert(G.format,G.colorSpace),ne=s.convert(G.type),Y=b(G.internalFormat,me,ne,G.colorSpace);if(!i.get(y).__hasExternalTextures){const ge=Math.max(1,y.width>>te),_e=Math.max(1,y.height>>te);J===t.TEXTURE_3D||J===t.TEXTURE_2D_ARRAY?n.texImage3D(J,te,Y,ge,_e,y.depth,0,me,ne,null):n.texImage2D(J,te,Y,ge,_e,0,me,ne,null)}n.bindFramebuffer(t.FRAMEBUFFER,A),Xe(y)?d.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ee,J,i.get(G).__webglTexture,0,be(y)):(J===t.TEXTURE_2D||J>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,ee,J,i.get(G).__webglTexture,te),n.bindFramebuffer(t.FRAMEBUFFER,null)}function F(A,y,G){if(t.bindRenderbuffer(t.RENDERBUFFER,A),y.depthBuffer&&!y.stencilBuffer){let ee=t.DEPTH_COMPONENT16;if(G||Xe(y)){const J=y.depthTexture;J&&J.isDepthTexture&&(J.type===wi?ee=t.DEPTH_COMPONENT32F:J.type===Ti&&(ee=t.DEPTH_COMPONENT24));const te=be(y);Xe(y)?d.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,te,ee,y.width,y.height):t.renderbufferStorageMultisample(t.RENDERBUFFER,te,ee,y.width,y.height)}else t.renderbufferStorage(t.RENDERBUFFER,ee,y.width,y.height);t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.RENDERBUFFER,A)}else if(y.depthBuffer&&y.stencilBuffer){const ee=be(y);G&&Xe(y)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,ee,t.DEPTH24_STENCIL8,y.width,y.height):Xe(y)?d.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ee,t.DEPTH24_STENCIL8,y.width,y.height):t.renderbufferStorage(t.RENDERBUFFER,t.DEPTH_STENCIL,y.width,y.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.RENDERBUFFER,A)}else{const ee=y.isWebGLMultipleRenderTargets===!0?y.texture:[y.texture];for(let J=0;J<ee.length;J++){const te=ee[J],me=s.convert(te.format,te.colorSpace),ne=s.convert(te.type),Y=b(te.internalFormat,me,ne,te.colorSpace),ve=be(y);G&&Xe(y)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,ve,Y,y.width,y.height):Xe(y)?d.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,ve,Y,y.width,y.height):t.renderbufferStorage(t.RENDERBUFFER,Y,y.width,y.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Rt(A,y){if(y&&y.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,A),!(y.depthTexture&&y.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(y.depthTexture).__webglTexture||y.depthTexture.image.width!==y.width||y.depthTexture.image.height!==y.height)&&(y.depthTexture.image.width=y.width,y.depthTexture.image.height=y.height,y.depthTexture.needsUpdate=!0),H(y.depthTexture,0);const ee=i.get(y.depthTexture).__webglTexture,J=be(y);if(y.depthTexture.format===or)Xe(y)?d.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0,J):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,ee,0);else if(y.depthTexture.format===ps)Xe(y)?d.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0,J):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function Me(A){const y=i.get(A),G=A.isWebGLCubeRenderTarget===!0;if(A.depthTexture&&!y.__autoAllocateDepthBuffer){if(G)throw new Error("target.depthTexture not supported in Cube render targets");Rt(y.__webglFramebuffer,A)}else if(G){y.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)n.bindFramebuffer(t.FRAMEBUFFER,y.__webglFramebuffer[ee]),y.__webglDepthbuffer[ee]=t.createRenderbuffer(),F(y.__webglDepthbuffer[ee],A,!1)}else n.bindFramebuffer(t.FRAMEBUFFER,y.__webglFramebuffer),y.__webglDepthbuffer=t.createRenderbuffer(),F(y.__webglDepthbuffer,A,!1);n.bindFramebuffer(t.FRAMEBUFFER,null)}function Re(A,y,G){const ee=i.get(A);y!==void 0&&Pe(ee.__webglFramebuffer,A,A.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),G!==void 0&&Me(A)}function Ae(A){const y=A.texture,G=i.get(A),ee=i.get(y);A.addEventListener("dispose",Z),A.isWebGLMultipleRenderTargets!==!0&&(ee.__webglTexture===void 0&&(ee.__webglTexture=t.createTexture()),ee.__version=y.version,o.memory.textures++);const J=A.isWebGLCubeRenderTarget===!0,te=A.isWebGLMultipleRenderTargets===!0,me=S(A)||a;if(J){G.__webglFramebuffer=[];for(let ne=0;ne<6;ne++)if(a&&y.mipmaps&&y.mipmaps.length>0){G.__webglFramebuffer[ne]=[];for(let Y=0;Y<y.mipmaps.length;Y++)G.__webglFramebuffer[ne][Y]=t.createFramebuffer()}else G.__webglFramebuffer[ne]=t.createFramebuffer()}else{if(a&&y.mipmaps&&y.mipmaps.length>0){G.__webglFramebuffer=[];for(let ne=0;ne<y.mipmaps.length;ne++)G.__webglFramebuffer[ne]=t.createFramebuffer()}else G.__webglFramebuffer=t.createFramebuffer();if(te)if(r.drawBuffers){const ne=A.texture;for(let Y=0,ve=ne.length;Y<ve;Y++){const ge=i.get(ne[Y]);ge.__webglTexture===void 0&&(ge.__webglTexture=t.createTexture(),o.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(a&&A.samples>0&&Xe(A)===!1){const ne=te?y:[y];G.__webglMultisampledFramebuffer=t.createFramebuffer(),G.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let Y=0;Y<ne.length;Y++){const ve=ne[Y];G.__webglColorRenderbuffer[Y]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,G.__webglColorRenderbuffer[Y]);const ge=s.convert(ve.format,ve.colorSpace),_e=s.convert(ve.type),de=b(ve.internalFormat,ge,_e,ve.colorSpace,A.isXRRenderTarget===!0),he=be(A);t.renderbufferStorageMultisample(t.RENDERBUFFER,he,de,A.width,A.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Y,t.RENDERBUFFER,G.__webglColorRenderbuffer[Y])}t.bindRenderbuffer(t.RENDERBUFFER,null),A.depthBuffer&&(G.__webglDepthRenderbuffer=t.createRenderbuffer(),F(G.__webglDepthRenderbuffer,A,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(J){n.bindTexture(t.TEXTURE_CUBE_MAP,ee.__webglTexture),Se(t.TEXTURE_CUBE_MAP,y,me);for(let ne=0;ne<6;ne++)if(a&&y.mipmaps&&y.mipmaps.length>0)for(let Y=0;Y<y.mipmaps.length;Y++)Pe(G.__webglFramebuffer[ne][Y],A,y,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,Y);else Pe(G.__webglFramebuffer[ne],A,y,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+ne,0);C(y,me)&&R(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(te){const ne=A.texture;for(let Y=0,ve=ne.length;Y<ve;Y++){const ge=ne[Y],_e=i.get(ge);n.bindTexture(t.TEXTURE_2D,_e.__webglTexture),Se(t.TEXTURE_2D,ge,me),Pe(G.__webglFramebuffer,A,ge,t.COLOR_ATTACHMENT0+Y,t.TEXTURE_2D,0),C(ge,me)&&R(t.TEXTURE_2D)}n.unbindTexture()}else{let ne=t.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(a?ne=A.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),n.bindTexture(ne,ee.__webglTexture),Se(ne,y,me),a&&y.mipmaps&&y.mipmaps.length>0)for(let Y=0;Y<y.mipmaps.length;Y++)Pe(G.__webglFramebuffer[Y],A,y,t.COLOR_ATTACHMENT0,ne,Y);else Pe(G.__webglFramebuffer,A,y,t.COLOR_ATTACHMENT0,ne,0);C(y,me)&&R(ne),n.unbindTexture()}A.depthBuffer&&Me(A)}function Je(A){const y=S(A)||a,G=A.isWebGLMultipleRenderTargets===!0?A.texture:[A.texture];for(let ee=0,J=G.length;ee<J;ee++){const te=G[ee];if(C(te,y)){const me=A.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:t.TEXTURE_2D,ne=i.get(te).__webglTexture;n.bindTexture(me,ne),R(me),n.unbindTexture()}}}function Oe(A){if(a&&A.samples>0&&Xe(A)===!1){const y=A.isWebGLMultipleRenderTargets?A.texture:[A.texture],G=A.width,ee=A.height;let J=t.COLOR_BUFFER_BIT;const te=[],me=A.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ne=i.get(A),Y=A.isWebGLMultipleRenderTargets===!0;if(Y)for(let ve=0;ve<y.length;ve++)n.bindFramebuffer(t.FRAMEBUFFER,ne.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ve,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,ne.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ve,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,ne.__webglMultisampledFramebuffer),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ne.__webglFramebuffer);for(let ve=0;ve<y.length;ve++){te.push(t.COLOR_ATTACHMENT0+ve),A.depthBuffer&&te.push(me);const ge=ne.__ignoreDepthValues!==void 0?ne.__ignoreDepthValues:!1;if(ge===!1&&(A.depthBuffer&&(J|=t.DEPTH_BUFFER_BIT),A.stencilBuffer&&(J|=t.STENCIL_BUFFER_BIT)),Y&&t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,ne.__webglColorRenderbuffer[ve]),ge===!0&&(t.invalidateFramebuffer(t.READ_FRAMEBUFFER,[me]),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[me])),Y){const _e=i.get(y[ve]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,_e,0)}t.blitFramebuffer(0,0,G,ee,0,0,G,ee,J,t.NEAREST),m&&t.invalidateFramebuffer(t.READ_FRAMEBUFFER,te)}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Y)for(let ve=0;ve<y.length;ve++){n.bindFramebuffer(t.FRAMEBUFFER,ne.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ve,t.RENDERBUFFER,ne.__webglColorRenderbuffer[ve]);const ge=i.get(y[ve]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,ne.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ve,t.TEXTURE_2D,ge,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,ne.__webglMultisampledFramebuffer)}}function be(A){return Math.min(h,A.samples)}function Xe(A){const y=i.get(A);return a&&A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&y.__useRenderToTexture!==!1}function Et(A){const y=o.render.frame;x.get(A)!==y&&(x.set(A,y),A.update())}function Ct(A,y){const G=A.colorSpace,ee=A.format,J=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||A.format===Ec||G!==Wn&&G!==lr&&(G===Ze||G===pl?a===!1?e.has("EXT_sRGB")===!0&&ee===Dn?(A.format=Ec,A.minFilter=mn,A.generateMipmaps=!1):y=$g.sRGBToLinear(y):(ee!==Dn||J!==Fi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",G)),y}this.allocateTextureUnit=P,this.resetTextureUnits=B,this.setTexture2D=H,this.setTexture2DArray=U,this.setTexture3D=k,this.setTextureCube=se,this.rebindTextures=Re,this.setupRenderTarget=Ae,this.updateRenderTargetMipmap=Je,this.updateMultisampleRenderTarget=Oe,this.setupDepthRenderbuffer=Me,this.setupFrameBufferTexture=Pe,this.useMultisampledRTT=Xe}const VT=0,ht=1;function WT(t,e,n){const i=n.isWebGL2;function r(s,o=lr){let a;const l=o===Ze||o===pl?ht:VT;if(s===Fi)return t.UNSIGNED_BYTE;if(s===Hg)return t.UNSIGNED_SHORT_4_4_4_4;if(s===Gg)return t.UNSIGNED_SHORT_5_5_5_1;if(s===yx)return t.BYTE;if(s===Mx)return t.SHORT;if(s===Tf)return t.UNSIGNED_SHORT;if(s===Bg)return t.INT;if(s===Ti)return t.UNSIGNED_INT;if(s===wi)return t.FLOAT;if(s===mo)return i?t.HALF_FLOAT:(a=e.get("OES_texture_half_float"),a!==null?a.HALF_FLOAT_OES:null);if(s===Ex)return t.ALPHA;if(s===Dn)return t.RGBA;if(s===Tx)return t.LUMINANCE;if(s===wx)return t.LUMINANCE_ALPHA;if(s===or)return t.DEPTH_COMPONENT;if(s===ps)return t.DEPTH_STENCIL;if(s===Ec)return a=e.get("EXT_sRGB"),a!==null?a.SRGB_ALPHA_EXT:null;if(s===Ax)return t.RED;if(s===Vg)return t.RED_INTEGER;if(s===Rx)return t.RG;if(s===Wg)return t.RG_INTEGER;if(s===Xg)return t.RGBA_INTEGER;if(s===$l||s===Kl||s===Zl||s===Ql)if(l===ht)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(s===$l)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Kl)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Zl)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===Ql)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(s===$l)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Kl)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Zl)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===Ql)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Jd||s===eh||s===th||s===nh)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(s===Jd)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===eh)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===th)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===nh)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Cx)return a=e.get("WEBGL_compressed_texture_etc1"),a!==null?a.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===ih||s===rh)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(s===ih)return l===ht?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(s===rh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===sh||s===oh||s===ah||s===lh||s===uh||s===ch||s===fh||s===dh||s===hh||s===ph||s===mh||s===gh||s===_h||s===vh)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(s===sh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===oh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===ah)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===lh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===uh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===ch)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===fh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===dh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===hh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===ph)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===mh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===gh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===_h)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===vh)return l===ht?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Jl||s===xh||s===Sh)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(s===Jl)return l===ht?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===xh)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===Sh)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===Lx||s===yh||s===Mh||s===Eh)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(s===Jl)return a.COMPRESSED_RED_RGTC1_EXT;if(s===yh)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===Mh)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Eh)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===sr?i?t.UNSIGNED_INT_24_8:(a=e.get("WEBGL_depth_texture"),a!==null?a.UNSIGNED_INT_24_8_WEBGL:null):t[s]!==void 0?t[s]:null}return{convert:r}}class XT extends gn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class fa extends It{constructor(){super(),this.isGroup=!0,this.type="Group"}}const jT={type:"move"};class Eu{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new fa,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new fa,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new V,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new V),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new fa,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new V,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new V),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const i of e.hand.values())this._getHandJoint(n,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const v of e.hand.values()){const p=n.getJointPose(v,i),c=this._getHandJoint(u,v);p!==null&&(c.matrix.fromArray(p.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,c.jointRadius=p.radius),c.visible=p!==null}const f=u.joints["index-finger-tip"],h=u.joints["thumb-tip"],d=f.position.distanceTo(h.position),m=.02,x=.005;u.inputState.pinching&&d>m+x?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&d<=m-x&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=n.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=n.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(jT)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const i=new fa;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[n.jointName]=i,e.add(i)}return e.joints[n.jointName]}}class YT extends Jt{constructor(e,n,i,r,s,o,a,l,u,f){if(f=f!==void 0?f:or,f!==or&&f!==ps)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&f===or&&(i=Ti),i===void 0&&f===ps&&(i=sr),super(null,r,s,o,a,l,f,i,u),this.isDepthTexture=!0,this.image={width:e,height:n},this.magFilter=a!==void 0?a:Bt,this.minFilter=l!==void 0?l:Bt,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const n=super.toJSON(e);return this.compareFunction!==null&&(n.compareFunction=this.compareFunction),n}}class qT extends xs{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,f=null,h=null,d=null,m=null,x=null;const v=n.getContextAttributes();let p=null,c=null;const _=[],g=[],S=new gn;S.layers.enable(1),S.viewport=new yt;const T=new gn;T.layers.enable(2),T.viewport=new yt;const C=[S,T],R=new XT;R.layers.enable(1),R.layers.enable(2);let b=null,M=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(U){let k=_[U];return k===void 0&&(k=new Eu,_[U]=k),k.getTargetRaySpace()},this.getControllerGrip=function(U){let k=_[U];return k===void 0&&(k=new Eu,_[U]=k),k.getGripSpace()},this.getHand=function(U){let k=_[U];return k===void 0&&(k=new Eu,_[U]=k),k.getHandSpace()};function w(U){const k=g.indexOf(U.inputSource);if(k===-1)return;const se=_[k];se!==void 0&&(se.update(U.inputSource,U.frame,u||o),se.dispatchEvent({type:U.type,data:U.inputSource}))}function N(){r.removeEventListener("select",w),r.removeEventListener("selectstart",w),r.removeEventListener("selectend",w),r.removeEventListener("squeeze",w),r.removeEventListener("squeezestart",w),r.removeEventListener("squeezeend",w),r.removeEventListener("end",N),r.removeEventListener("inputsourceschange",Z);for(let U=0;U<_.length;U++){const k=g[U];k!==null&&(g[U]=null,_[U].disconnect(k))}b=null,M=null,e.setRenderTarget(p),m=null,d=null,h=null,r=null,c=null,H.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(U){s=U,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(U){a=U,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(U){u=U},this.getBaseLayer=function(){return d!==null?d:m},this.getBinding=function(){return h},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=async function(U){if(r=U,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",w),r.addEventListener("selectstart",w),r.addEventListener("selectend",w),r.addEventListener("squeeze",w),r.addEventListener("squeezestart",w),r.addEventListener("squeezeend",w),r.addEventListener("end",N),r.addEventListener("inputsourceschange",Z),v.xrCompatible!==!0&&await n.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const k={antialias:r.renderState.layers===void 0?v.antialias:!0,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,k),r.updateRenderState({baseLayer:m}),c=new mr(m.framebufferWidth,m.framebufferHeight,{format:Dn,type:Fi,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil})}else{let k=null,se=null,oe=null;v.depth&&(oe=v.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,k=v.stencil?ps:or,se=v.stencil?sr:Ti);const ue={colorFormat:n.RGBA8,depthFormat:oe,scaleFactor:s};h=new XRWebGLBinding(r,n),d=h.createProjectionLayer(ue),r.updateRenderState({layers:[d]}),c=new mr(d.textureWidth,d.textureHeight,{format:Dn,type:Fi,depthTexture:new YT(d.textureWidth,d.textureHeight,se,void 0,void 0,void 0,void 0,void 0,void 0,k),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0});const pe=e.properties.get(c);pe.__ignoreDepthValues=d.ignoreDepthValues}c.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),H.setContext(r),H.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function Z(U){for(let k=0;k<U.removed.length;k++){const se=U.removed[k],oe=g.indexOf(se);oe>=0&&(g[oe]=null,_[oe].disconnect(se))}for(let k=0;k<U.added.length;k++){const se=U.added[k];let oe=g.indexOf(se);if(oe===-1){for(let pe=0;pe<_.length;pe++)if(pe>=g.length){g.push(se),oe=pe;break}else if(g[pe]===null){g[pe]=se,oe=pe;break}if(oe===-1)break}const ue=_[oe];ue&&ue.connect(se)}}const D=new V,z=new V;function W(U,k,se){D.setFromMatrixPosition(k.matrixWorld),z.setFromMatrixPosition(se.matrixWorld);const oe=D.distanceTo(z),ue=k.projectionMatrix.elements,pe=se.projectionMatrix.elements,Se=ue[14]/(ue[10]-1),ye=ue[14]/(ue[10]+1),Ge=(ue[9]+1)/ue[5],Wt=(ue[9]-1)/ue[5],Pe=(ue[8]-1)/ue[0],F=(pe[8]+1)/pe[0],Rt=Se*Pe,Me=Se*F,Re=oe/(-Pe+F),Ae=Re*-Pe;k.matrixWorld.decompose(U.position,U.quaternion,U.scale),U.translateX(Ae),U.translateZ(Re),U.matrixWorld.compose(U.position,U.quaternion,U.scale),U.matrixWorldInverse.copy(U.matrixWorld).invert();const Je=Se+Re,Oe=ye+Re,be=Rt-Ae,Xe=Me+(oe-Ae),Et=Ge*ye/Oe*Je,Ct=Wt*ye/Oe*Je;U.projectionMatrix.makePerspective(be,Xe,Et,Ct,Je,Oe),U.projectionMatrixInverse.copy(U.projectionMatrix).invert()}function K(U,k){k===null?U.matrixWorld.copy(U.matrix):U.matrixWorld.multiplyMatrices(k.matrixWorld,U.matrix),U.matrixWorldInverse.copy(U.matrixWorld).invert()}this.updateCamera=function(U){if(r===null)return;R.near=T.near=S.near=U.near,R.far=T.far=S.far=U.far,(b!==R.near||M!==R.far)&&(r.updateRenderState({depthNear:R.near,depthFar:R.far}),b=R.near,M=R.far);const k=U.parent,se=R.cameras;K(R,k);for(let oe=0;oe<se.length;oe++)K(se[oe],k);se.length===2?W(R,S,T):R.projectionMatrix.copy(S.projectionMatrix),B(U,R,k)};function B(U,k,se){se===null?U.matrix.copy(k.matrixWorld):(U.matrix.copy(se.matrixWorld),U.matrix.invert(),U.matrix.multiply(k.matrixWorld)),U.matrix.decompose(U.position,U.quaternion,U.scale),U.updateMatrixWorld(!0),U.projectionMatrix.copy(k.projectionMatrix),U.projectionMatrixInverse.copy(k.projectionMatrixInverse),U.isPerspectiveCamera&&(U.fov=Tc*2*Math.atan(1/U.projectionMatrix.elements[5]),U.zoom=1)}this.getCamera=function(){return R},this.getFoveation=function(){if(!(d===null&&m===null))return l},this.setFoveation=function(U){l=U,d!==null&&(d.fixedFoveation=U),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=U)};let P=null;function X(U,k){if(f=k.getViewerPose(u||o),x=k,f!==null){const se=f.views;m!==null&&(e.setRenderTargetFramebuffer(c,m.framebuffer),e.setRenderTarget(c));let oe=!1;se.length!==R.cameras.length&&(R.cameras.length=0,oe=!0);for(let ue=0;ue<se.length;ue++){const pe=se[ue];let Se=null;if(m!==null)Se=m.getViewport(pe);else{const Ge=h.getViewSubImage(d,pe);Se=Ge.viewport,ue===0&&(e.setRenderTargetTextures(c,Ge.colorTexture,d.ignoreDepthValues?void 0:Ge.depthStencilTexture),e.setRenderTarget(c))}let ye=C[ue];ye===void 0&&(ye=new gn,ye.layers.enable(ue),ye.viewport=new yt,C[ue]=ye),ye.matrix.fromArray(pe.transform.matrix),ye.matrix.decompose(ye.position,ye.quaternion,ye.scale),ye.projectionMatrix.fromArray(pe.projectionMatrix),ye.projectionMatrixInverse.copy(ye.projectionMatrix).invert(),ye.viewport.set(Se.x,Se.y,Se.width,Se.height),ue===0&&(R.matrix.copy(ye.matrix),R.matrix.decompose(R.position,R.quaternion,R.scale)),oe===!0&&R.cameras.push(ye)}}for(let se=0;se<_.length;se++){const oe=g[se],ue=_[se];oe!==null&&ue!==void 0&&ue.update(oe,k,u||o)}P&&P(U,k),k.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:k}),x=null}const H=new o_;H.setAnimationLoop(X),this.setAnimationLoop=function(U){P=U},this.dispose=function(){}}}function $T(t,e){function n(p,c){p.matrixAutoUpdate===!0&&p.updateMatrix(),c.value.copy(p.matrix)}function i(p,c){c.color.getRGB(p.fogColor.value,i_(t)),c.isFog?(p.fogNear.value=c.near,p.fogFar.value=c.far):c.isFogExp2&&(p.fogDensity.value=c.density)}function r(p,c,_,g,S){c.isMeshBasicMaterial||c.isMeshLambertMaterial?s(p,c):c.isMeshToonMaterial?(s(p,c),h(p,c)):c.isMeshPhongMaterial?(s(p,c),f(p,c)):c.isMeshStandardMaterial?(s(p,c),d(p,c),c.isMeshPhysicalMaterial&&m(p,c,S)):c.isMeshMatcapMaterial?(s(p,c),x(p,c)):c.isMeshDepthMaterial?s(p,c):c.isMeshDistanceMaterial?(s(p,c),v(p,c)):c.isMeshNormalMaterial?s(p,c):c.isLineBasicMaterial?(o(p,c),c.isLineDashedMaterial&&a(p,c)):c.isPointsMaterial?l(p,c,_,g):c.isSpriteMaterial?u(p,c):c.isShadowMaterial?(p.color.value.copy(c.color),p.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(p,c){p.opacity.value=c.opacity,c.color&&p.diffuse.value.copy(c.color),c.emissive&&p.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.bumpMap&&(p.bumpMap.value=c.bumpMap,n(c.bumpMap,p.bumpMapTransform),p.bumpScale.value=c.bumpScale,c.side===Qt&&(p.bumpScale.value*=-1)),c.normalMap&&(p.normalMap.value=c.normalMap,n(c.normalMap,p.normalMapTransform),p.normalScale.value.copy(c.normalScale),c.side===Qt&&p.normalScale.value.negate()),c.displacementMap&&(p.displacementMap.value=c.displacementMap,n(c.displacementMap,p.displacementMapTransform),p.displacementScale.value=c.displacementScale,p.displacementBias.value=c.displacementBias),c.emissiveMap&&(p.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,p.emissiveMapTransform)),c.specularMap&&(p.specularMap.value=c.specularMap,n(c.specularMap,p.specularMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest);const _=e.get(c).envMap;if(_&&(p.envMap.value=_,p.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=c.reflectivity,p.ior.value=c.ior,p.refractionRatio.value=c.refractionRatio),c.lightMap){p.lightMap.value=c.lightMap;const g=t._useLegacyLights===!0?Math.PI:1;p.lightMapIntensity.value=c.lightMapIntensity*g,n(c.lightMap,p.lightMapTransform)}c.aoMap&&(p.aoMap.value=c.aoMap,p.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,p.aoMapTransform))}function o(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform))}function a(p,c){p.dashSize.value=c.dashSize,p.totalSize.value=c.dashSize+c.gapSize,p.scale.value=c.scale}function l(p,c,_,g){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.size.value=c.size*_,p.scale.value=g*.5,c.map&&(p.map.value=c.map,n(c.map,p.uvTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function u(p,c){p.diffuse.value.copy(c.color),p.opacity.value=c.opacity,p.rotation.value=c.rotation,c.map&&(p.map.value=c.map,n(c.map,p.mapTransform)),c.alphaMap&&(p.alphaMap.value=c.alphaMap,n(c.alphaMap,p.alphaMapTransform)),c.alphaTest>0&&(p.alphaTest.value=c.alphaTest)}function f(p,c){p.specular.value.copy(c.specular),p.shininess.value=Math.max(c.shininess,1e-4)}function h(p,c){c.gradientMap&&(p.gradientMap.value=c.gradientMap)}function d(p,c){p.metalness.value=c.metalness,c.metalnessMap&&(p.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,p.metalnessMapTransform)),p.roughness.value=c.roughness,c.roughnessMap&&(p.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,p.roughnessMapTransform)),e.get(c).envMap&&(p.envMapIntensity.value=c.envMapIntensity)}function m(p,c,_){p.ior.value=c.ior,c.sheen>0&&(p.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),p.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(p.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,p.sheenColorMapTransform)),c.sheenRoughnessMap&&(p.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,p.sheenRoughnessMapTransform))),c.clearcoat>0&&(p.clearcoat.value=c.clearcoat,p.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(p.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,p.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(p.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===Qt&&p.clearcoatNormalScale.value.negate())),c.iridescence>0&&(p.iridescence.value=c.iridescence,p.iridescenceIOR.value=c.iridescenceIOR,p.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(p.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,p.iridescenceMapTransform)),c.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),c.transmission>0&&(p.transmission.value=c.transmission,p.transmissionSamplerMap.value=_.texture,p.transmissionSamplerSize.value.set(_.width,_.height),c.transmissionMap&&(p.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,p.transmissionMapTransform)),p.thickness.value=c.thickness,c.thicknessMap&&(p.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=c.attenuationDistance,p.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(p.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(p.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=c.specularIntensity,p.specularColor.value.copy(c.specularColor),c.specularColorMap&&(p.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,p.specularColorMapTransform)),c.specularIntensityMap&&(p.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,p.specularIntensityMapTransform))}function x(p,c){c.matcap&&(p.matcap.value=c.matcap)}function v(p,c){const _=e.get(c).light;p.referencePosition.value.setFromMatrixPosition(_.matrixWorld),p.nearDistance.value=_.shadow.camera.near,p.farDistance.value=_.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function KT(t,e,n,i){let r={},s={},o=[];const a=n.isWebGL2?t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(_,g){const S=g.program;i.uniformBlockBinding(_,S)}function u(_,g){let S=r[_.id];S===void 0&&(x(_),S=f(_),r[_.id]=S,_.addEventListener("dispose",p));const T=g.program;i.updateUBOMapping(_,T);const C=e.render.frame;s[_.id]!==C&&(d(_),s[_.id]=C)}function f(_){const g=h();_.__bindingPointIndex=g;const S=t.createBuffer(),T=_.__size,C=_.usage;return t.bindBuffer(t.UNIFORM_BUFFER,S),t.bufferData(t.UNIFORM_BUFFER,T,C),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,g,S),S}function h(){for(let _=0;_<a;_++)if(o.indexOf(_)===-1)return o.push(_),_;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(_){const g=r[_.id],S=_.uniforms,T=_.__cache;t.bindBuffer(t.UNIFORM_BUFFER,g);for(let C=0,R=S.length;C<R;C++){const b=S[C];if(m(b,C,T)===!0){const M=b.__offset,w=Array.isArray(b.value)?b.value:[b.value];let N=0;for(let Z=0;Z<w.length;Z++){const D=w[Z],z=v(D);typeof D=="number"?(b.__data[0]=D,t.bufferSubData(t.UNIFORM_BUFFER,M+N,b.__data)):D.isMatrix3?(b.__data[0]=D.elements[0],b.__data[1]=D.elements[1],b.__data[2]=D.elements[2],b.__data[3]=D.elements[0],b.__data[4]=D.elements[3],b.__data[5]=D.elements[4],b.__data[6]=D.elements[5],b.__data[7]=D.elements[0],b.__data[8]=D.elements[6],b.__data[9]=D.elements[7],b.__data[10]=D.elements[8],b.__data[11]=D.elements[0]):(D.toArray(b.__data,N),N+=z.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,M,b.__data)}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(_,g,S){const T=_.value;if(S[g]===void 0){if(typeof T=="number")S[g]=T;else{const C=Array.isArray(T)?T:[T],R=[];for(let b=0;b<C.length;b++)R.push(C[b].clone());S[g]=R}return!0}else if(typeof T=="number"){if(S[g]!==T)return S[g]=T,!0}else{const C=Array.isArray(S[g])?S[g]:[S[g]],R=Array.isArray(T)?T:[T];for(let b=0;b<C.length;b++){const M=C[b];if(M.equals(R[b])===!1)return M.copy(R[b]),!0}}return!1}function x(_){const g=_.uniforms;let S=0;const T=16;let C=0;for(let R=0,b=g.length;R<b;R++){const M=g[R],w={boundary:0,storage:0},N=Array.isArray(M.value)?M.value:[M.value];for(let Z=0,D=N.length;Z<D;Z++){const z=N[Z],W=v(z);w.boundary+=W.boundary,w.storage+=W.storage}if(M.__data=new Float32Array(w.storage/Float32Array.BYTES_PER_ELEMENT),M.__offset=S,R>0){C=S%T;const Z=T-C;C!==0&&Z-w.boundary<0&&(S+=T-C,M.__offset=S)}S+=w.storage}return C=S%T,C>0&&(S+=T-C),_.__size=S,_.__cache={},this}function v(_){const g={boundary:0,storage:0};return typeof _=="number"?(g.boundary=4,g.storage=4):_.isVector2?(g.boundary=8,g.storage=8):_.isVector3||_.isColor?(g.boundary=16,g.storage=12):_.isVector4?(g.boundary=16,g.storage=16):_.isMatrix3?(g.boundary=48,g.storage=48):_.isMatrix4?(g.boundary=64,g.storage=64):_.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",_),g}function p(_){const g=_.target;g.removeEventListener("dispose",p);const S=o.indexOf(g.__bindingPointIndex);o.splice(S,1),t.deleteBuffer(r[g.id]),delete r[g.id],delete s[g.id]}function c(){for(const _ in r)t.deleteBuffer(r[_]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}class d_{constructor(e={}){const{canvas:n=Vx(),context:i=null,depth:r=!0,stencil:s=!0,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:h=!1}=e;this.isWebGLRenderer=!0;let d;i!==null?d=i.getContextAttributes().alpha:d=o;const m=new Uint32Array(4),x=new Int32Array(4);let v=null,p=null;const c=[],_=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.outputColorSpace=Ze,this._useLegacyLights=!1,this.toneMapping=Ni,this.toneMappingExposure=1;const g=this;let S=!1,T=0,C=0,R=null,b=-1,M=null;const w=new yt,N=new yt;let Z=null;const D=new We(0);let z=0,W=n.width,K=n.height,B=1,P=null,X=null;const H=new yt(0,0,W,K),U=new yt(0,0,W,K);let k=!1;const se=new Rf;let oe=!1,ue=!1,pe=null;const Se=new gt,ye=new He,Ge=new V,Wt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function Pe(){return R===null?B:1}let F=i;function Rt(E,I){for(let q=0;q<E.length;q++){const O=E[q],$=n.getContext(O,I);if($!==null)return $}return null}try{const E={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:f,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Ef}`),n.addEventListener("webglcontextlost",ae,!1),n.addEventListener("webglcontextrestored",j,!1),n.addEventListener("webglcontextcreationerror",ie,!1),F===null){const I=["webgl2","webgl","experimental-webgl"];if(g.isWebGL1Renderer===!0&&I.shift(),F=Rt(I,E),F===null)throw Rt(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&F instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),F.getShaderPrecisionFormat===void 0&&(F.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let Me,Re,Ae,Je,Oe,be,Xe,Et,Ct,A,y,G,ee,J,te,me,ne,Y,ve,ge,_e,de,he,Ue;function je(){Me=new oE(F),Re=new eE(F,Me,e),Me.init(Re),de=new WT(F,Me,Re),Ae=new HT(F,Me,Re),Je=new uE(F),Oe=new RT,be=new GT(F,Me,Ae,Oe,Re,de,Je),Xe=new nE(g),Et=new sE(g),Ct=new xS(F,Re),he=new QM(F,Me,Ct,Re),A=new aE(F,Ct,Je,he),y=new hE(F,A,Ct,Je),ve=new dE(F,Re,be),me=new tE(Oe),G=new AT(g,Xe,Et,Me,Re,he,me),ee=new $T(g,Oe),J=new LT,te=new NT(Me,Re),Y=new ZM(g,Xe,Et,Ae,y,d,l),ne=new BT(g,y,Re),Ue=new KT(F,Je,Re,Ae),ge=new JM(F,Me,Je,Re),_e=new lE(F,Me,Je,Re),Je.programs=G.programs,g.capabilities=Re,g.extensions=Me,g.properties=Oe,g.renderLists=J,g.shadowMap=ne,g.state=Ae,g.info=Je}je();const L=new qT(g,F);this.xr=L,this.getContext=function(){return F},this.getContextAttributes=function(){return F.getContextAttributes()},this.forceContextLoss=function(){const E=Me.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=Me.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return B},this.setPixelRatio=function(E){E!==void 0&&(B=E,this.setSize(W,K,!1))},this.getSize=function(E){return E.set(W,K)},this.setSize=function(E,I,q=!0){if(L.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}W=E,K=I,n.width=Math.floor(E*B),n.height=Math.floor(I*B),q===!0&&(n.style.width=E+"px",n.style.height=I+"px"),this.setViewport(0,0,E,I)},this.getDrawingBufferSize=function(E){return E.set(W*B,K*B).floor()},this.setDrawingBufferSize=function(E,I,q){W=E,K=I,B=q,n.width=Math.floor(E*q),n.height=Math.floor(I*q),this.setViewport(0,0,E,I)},this.getCurrentViewport=function(E){return E.copy(w)},this.getViewport=function(E){return E.copy(H)},this.setViewport=function(E,I,q,O){E.isVector4?H.set(E.x,E.y,E.z,E.w):H.set(E,I,q,O),Ae.viewport(w.copy(H).multiplyScalar(B).floor())},this.getScissor=function(E){return E.copy(U)},this.setScissor=function(E,I,q,O){E.isVector4?U.set(E.x,E.y,E.z,E.w):U.set(E,I,q,O),Ae.scissor(N.copy(U).multiplyScalar(B).floor())},this.getScissorTest=function(){return k},this.setScissorTest=function(E){Ae.setScissorTest(k=E)},this.setOpaqueSort=function(E){P=E},this.setTransparentSort=function(E){X=E},this.getClearColor=function(E){return E.copy(Y.getClearColor())},this.setClearColor=function(){Y.setClearColor.apply(Y,arguments)},this.getClearAlpha=function(){return Y.getClearAlpha()},this.setClearAlpha=function(){Y.setClearAlpha.apply(Y,arguments)},this.clear=function(E=!0,I=!0,q=!0){let O=0;if(E){let $=!1;if(R!==null){const fe=R.texture.format;$=fe===Xg||fe===Wg||fe===Vg}if($){const fe=R.texture.type,xe=fe===Fi||fe===Ti||fe===Tf||fe===sr||fe===Hg||fe===Gg,Te=Y.getClearColor(),we=Y.getClearAlpha(),Ie=Te.r,Ee=Te.g,Ce=Te.b;xe?(m[0]=Ie,m[1]=Ee,m[2]=Ce,m[3]=we,F.clearBufferuiv(F.COLOR,0,m)):(x[0]=Ie,x[1]=Ee,x[2]=Ce,x[3]=we,F.clearBufferiv(F.COLOR,0,x))}else O|=F.COLOR_BUFFER_BIT}I&&(O|=F.DEPTH_BUFFER_BIT),q&&(O|=F.STENCIL_BUFFER_BIT),F.clear(O)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",ae,!1),n.removeEventListener("webglcontextrestored",j,!1),n.removeEventListener("webglcontextcreationerror",ie,!1),J.dispose(),te.dispose(),Oe.dispose(),Xe.dispose(),Et.dispose(),y.dispose(),he.dispose(),Ue.dispose(),G.dispose(),L.dispose(),L.removeEventListener("sessionstart",qe),L.removeEventListener("sessionend",Fn),pe&&(pe.dispose(),pe=null),Ft.stop()};function ae(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),S=!0}function j(){console.log("THREE.WebGLRenderer: Context Restored."),S=!1;const E=Je.autoReset,I=ne.enabled,q=ne.autoUpdate,O=ne.needsUpdate,$=ne.type;je(),Je.autoReset=E,ne.enabled=I,ne.autoUpdate=q,ne.needsUpdate=O,ne.type=$}function ie(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function le(E){const I=E.target;I.removeEventListener("dispose",le),ke(I)}function ke(E){et(E),Oe.remove(E)}function et(E){const I=Oe.get(E).programs;I!==void 0&&(I.forEach(function(q){G.releaseProgram(q)}),E.isShaderMaterial&&G.releaseShaderCache(E))}this.renderBufferDirect=function(E,I,q,O,$,fe){I===null&&(I=Wt);const xe=$.isMesh&&$.matrixWorld.determinant()<0,Te=m_(E,I,q,O,$);Ae.setMaterial(O,xe);let we=q.index,Ie=1;if(O.wireframe===!0){if(we=A.getWireframeAttribute(q),we===void 0)return;Ie=2}const Ee=q.drawRange,Ce=q.attributes.position;let rt=Ee.start*Ie,ot=(Ee.start+Ee.count)*Ie;fe!==null&&(rt=Math.max(rt,fe.start*Ie),ot=Math.min(ot,(fe.start+fe.count)*Ie)),we!==null?(rt=Math.max(rt,0),ot=Math.min(ot,we.count)):Ce!=null&&(rt=Math.max(rt,0),ot=Math.min(ot,Ce.count));const cn=ot-rt;if(cn<0||cn===1/0)return;he.setup($,O,Te,q,we);let Xn,ut=ge;if(we!==null&&(Xn=Ct.get(we),ut=_e,ut.setIndex(Xn)),$.isMesh)O.wireframe===!0?(Ae.setLineWidth(O.wireframeLinewidth*Pe()),ut.setMode(F.LINES)):ut.setMode(F.TRIANGLES);else if($.isLine){let Ne=O.linewidth;Ne===void 0&&(Ne=1),Ae.setLineWidth(Ne*Pe()),$.isLineSegments?ut.setMode(F.LINES):$.isLineLoop?ut.setMode(F.LINE_LOOP):ut.setMode(F.LINE_STRIP)}else $.isPoints?ut.setMode(F.POINTS):$.isSprite&&ut.setMode(F.TRIANGLES);if($.isInstancedMesh)ut.renderInstances(rt,cn,$.count);else if(q.isInstancedBufferGeometry){const Ne=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,vl=Math.min(q.instanceCount,Ne);ut.renderInstances(rt,cn,vl)}else ut.render(rt,cn)},this.compile=function(E,I){function q(O,$,fe){O.transparent===!0&&O.side===ti&&O.forceSinglePass===!1?(O.side=Qt,O.needsUpdate=!0,Ro(O,$,fe),O.side=ki,O.needsUpdate=!0,Ro(O,$,fe),O.side=ti):Ro(O,$,fe)}p=te.get(E),p.init(),_.push(p),E.traverseVisible(function(O){O.isLight&&O.layers.test(I.layers)&&(p.pushLight(O),O.castShadow&&p.pushShadow(O))}),p.setupLights(g._useLegacyLights),E.traverse(function(O){const $=O.material;if($)if(Array.isArray($))for(let fe=0;fe<$.length;fe++){const xe=$[fe];q(xe,E,O)}else q($,E,O)}),_.pop(),p=null};let lt=null;function di(E){lt&&lt(E)}function qe(){Ft.stop()}function Fn(){Ft.start()}const Ft=new o_;Ft.setAnimationLoop(di),typeof self<"u"&&Ft.setContext(self),this.setAnimationLoop=function(E){lt=E,L.setAnimationLoop(E),E===null?Ft.stop():Ft.start()},L.addEventListener("sessionstart",qe),L.addEventListener("sessionend",Fn),this.render=function(E,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),L.enabled===!0&&L.isPresenting===!0&&(L.cameraAutoUpdate===!0&&L.updateCamera(I),I=L.getCamera()),E.isScene===!0&&E.onBeforeRender(g,E,I,R),p=te.get(E,_.length),p.init(),_.push(p),Se.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),se.setFromProjectionMatrix(Se),ue=this.localClippingEnabled,oe=me.init(this.clippingPlanes,ue),v=J.get(E,c.length),v.init(),c.push(v),bf(E,I,0,g.sortObjects),v.finish(),g.sortObjects===!0&&v.sort(P,X),this.info.render.frame++,oe===!0&&me.beginShadows();const q=p.state.shadowsArray;if(ne.render(q,E,I),oe===!0&&me.endShadows(),this.info.autoReset===!0&&this.info.reset(),Y.render(v,E),p.setupLights(g._useLegacyLights),I.isArrayCamera){const O=I.cameras;for(let $=0,fe=O.length;$<fe;$++){const xe=O[$];Df(v,E,xe,xe.viewport)}}else Df(v,E,I);R!==null&&(be.updateMultisampleRenderTarget(R),be.updateRenderTargetMipmap(R)),E.isScene===!0&&E.onAfterRender(g,E,I),he.resetDefaultState(),b=-1,M=null,_.pop(),_.length>0?p=_[_.length-1]:p=null,c.pop(),c.length>0?v=c[c.length-1]:v=null};function bf(E,I,q,O){if(E.visible===!1)return;if(E.layers.test(I.layers)){if(E.isGroup)q=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(I);else if(E.isLight)p.pushLight(E),E.castShadow&&p.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||se.intersectsSprite(E)){O&&Ge.setFromMatrixPosition(E.matrixWorld).applyMatrix4(Se);const xe=y.update(E),Te=E.material;Te.visible&&v.push(E,xe,Te,q,Ge.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(!E.frustumCulled||se.intersectsObject(E))){const xe=y.update(E),Te=E.material;if(O&&(E.boundingSphere!==void 0?(E.boundingSphere===null&&E.computeBoundingSphere(),Ge.copy(E.boundingSphere.center)):(xe.boundingSphere===null&&xe.computeBoundingSphere(),Ge.copy(xe.boundingSphere.center)),Ge.applyMatrix4(E.matrixWorld).applyMatrix4(Se)),Array.isArray(Te)){const we=xe.groups;for(let Ie=0,Ee=we.length;Ie<Ee;Ie++){const Ce=we[Ie],rt=Te[Ce.materialIndex];rt&&rt.visible&&v.push(E,xe,rt,q,Ge.z,Ce)}}else Te.visible&&v.push(E,xe,Te,q,Ge.z,null)}}const fe=E.children;for(let xe=0,Te=fe.length;xe<Te;xe++)bf(fe[xe],I,q,O)}function Df(E,I,q,O){const $=E.opaque,fe=E.transmissive,xe=E.transparent;p.setupLightsView(q),oe===!0&&me.setGlobalState(g.clippingPlanes,q),fe.length>0&&p_($,fe,I,q),O&&Ae.viewport(w.copy(O)),$.length>0&&Ao($,I,q),fe.length>0&&Ao(fe,I,q),xe.length>0&&Ao(xe,I,q),Ae.buffers.depth.setTest(!0),Ae.buffers.depth.setMask(!0),Ae.buffers.color.setMask(!0),Ae.setPolygonOffset(!1)}function p_(E,I,q,O){const $=Re.isWebGL2;pe===null&&(pe=new mr(1,1,{generateMipmaps:!0,type:Me.has("EXT_color_buffer_half_float")?mo:Fi,minFilter:po,samples:$?4:0})),g.getDrawingBufferSize(ye),$?pe.setSize(ye.x,ye.y):pe.setSize(wc(ye.x),wc(ye.y));const fe=g.getRenderTarget();g.setRenderTarget(pe),g.getClearColor(D),z=g.getClearAlpha(),z<1&&g.setClearColor(16777215,.5),g.clear();const xe=g.toneMapping;g.toneMapping=Ni,Ao(E,q,O),be.updateMultisampleRenderTarget(pe),be.updateRenderTargetMipmap(pe);let Te=!1;for(let we=0,Ie=I.length;we<Ie;we++){const Ee=I[we],Ce=Ee.object,rt=Ee.geometry,ot=Ee.material,cn=Ee.group;if(ot.side===ti&&Ce.layers.test(O.layers)){const Xn=ot.side;ot.side=Qt,ot.needsUpdate=!0,Uf(Ce,q,O,rt,ot,cn),ot.side=Xn,ot.needsUpdate=!0,Te=!0}}Te===!0&&(be.updateMultisampleRenderTarget(pe),be.updateRenderTargetMipmap(pe)),g.setRenderTarget(fe),g.setClearColor(D,z),g.toneMapping=xe}function Ao(E,I,q){const O=I.isScene===!0?I.overrideMaterial:null;for(let $=0,fe=E.length;$<fe;$++){const xe=E[$],Te=xe.object,we=xe.geometry,Ie=O===null?xe.material:O,Ee=xe.group;Te.layers.test(q.layers)&&Uf(Te,I,q,we,Ie,Ee)}}function Uf(E,I,q,O,$,fe){E.onBeforeRender(g,I,q,O,$,fe),E.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),$.onBeforeRender(g,I,q,O,E,fe),$.transparent===!0&&$.side===ti&&$.forceSinglePass===!1?($.side=Qt,$.needsUpdate=!0,g.renderBufferDirect(q,I,O,$,E,fe),$.side=ki,$.needsUpdate=!0,g.renderBufferDirect(q,I,O,$,E,fe),$.side=ti):g.renderBufferDirect(q,I,O,$,E,fe),E.onAfterRender(g,I,q,O,$,fe)}function Ro(E,I,q){I.isScene!==!0&&(I=Wt);const O=Oe.get(E),$=p.state.lights,fe=p.state.shadowsArray,xe=$.state.version,Te=G.getParameters(E,$.state,fe,I,q),we=G.getProgramCacheKey(Te);let Ie=O.programs;O.environment=E.isMeshStandardMaterial?I.environment:null,O.fog=I.fog,O.envMap=(E.isMeshStandardMaterial?Et:Xe).get(E.envMap||O.environment),Ie===void 0&&(E.addEventListener("dispose",le),Ie=new Map,O.programs=Ie);let Ee=Ie.get(we);if(Ee!==void 0){if(O.currentProgram===Ee&&O.lightsStateVersion===xe)return If(E,Te),Ee}else Te.uniforms=G.getUniforms(E),E.onBuild(q,Te,g),E.onBeforeCompile(Te,g),Ee=G.acquireProgram(Te,we),Ie.set(we,Ee),O.uniforms=Te.uniforms;const Ce=O.uniforms;(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ce.clippingPlanes=me.uniform),If(E,Te),O.needsLights=__(E),O.lightsStateVersion=xe,O.needsLights&&(Ce.ambientLightColor.value=$.state.ambient,Ce.lightProbe.value=$.state.probe,Ce.directionalLights.value=$.state.directional,Ce.directionalLightShadows.value=$.state.directionalShadow,Ce.spotLights.value=$.state.spot,Ce.spotLightShadows.value=$.state.spotShadow,Ce.rectAreaLights.value=$.state.rectArea,Ce.ltc_1.value=$.state.rectAreaLTC1,Ce.ltc_2.value=$.state.rectAreaLTC2,Ce.pointLights.value=$.state.point,Ce.pointLightShadows.value=$.state.pointShadow,Ce.hemisphereLights.value=$.state.hemi,Ce.directionalShadowMap.value=$.state.directionalShadowMap,Ce.directionalShadowMatrix.value=$.state.directionalShadowMatrix,Ce.spotShadowMap.value=$.state.spotShadowMap,Ce.spotLightMatrix.value=$.state.spotLightMatrix,Ce.spotLightMap.value=$.state.spotLightMap,Ce.pointShadowMap.value=$.state.pointShadowMap,Ce.pointShadowMatrix.value=$.state.pointShadowMatrix);const rt=Ee.getUniforms(),ot=Ta.seqWithValue(rt.seq,Ce);return O.currentProgram=Ee,O.uniformsList=ot,Ee}function If(E,I){const q=Oe.get(E);q.outputColorSpace=I.outputColorSpace,q.instancing=I.instancing,q.instancingColor=I.instancingColor,q.skinning=I.skinning,q.morphTargets=I.morphTargets,q.morphNormals=I.morphNormals,q.morphColors=I.morphColors,q.morphTargetsCount=I.morphTargetsCount,q.numClippingPlanes=I.numClippingPlanes,q.numIntersection=I.numClipIntersection,q.vertexAlphas=I.vertexAlphas,q.vertexTangents=I.vertexTangents,q.toneMapping=I.toneMapping}function m_(E,I,q,O,$){I.isScene!==!0&&(I=Wt),be.resetTextureUnits();const fe=I.fog,xe=O.isMeshStandardMaterial?I.environment:null,Te=R===null?g.outputColorSpace:R.isXRRenderTarget===!0?R.texture.colorSpace:Wn,we=(O.isMeshStandardMaterial?Et:Xe).get(O.envMap||xe),Ie=O.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Ee=!!q.attributes.tangent&&(!!O.normalMap||O.anisotropy>0),Ce=!!q.morphAttributes.position,rt=!!q.morphAttributes.normal,ot=!!q.morphAttributes.color;let cn=Ni;O.toneMapped&&(R===null||R.isXRRenderTarget===!0)&&(cn=g.toneMapping);const Xn=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,ut=Xn!==void 0?Xn.length:0,Ne=Oe.get(O),vl=p.state.lights;if(oe===!0&&(ue===!0||E!==M)){const en=E===M&&O.id===b;me.setState(O,E,en)}let ct=!1;O.version===Ne.__version?(Ne.needsLights&&Ne.lightsStateVersion!==vl.state.version||Ne.outputColorSpace!==Te||$.isInstancedMesh&&Ne.instancing===!1||!$.isInstancedMesh&&Ne.instancing===!0||$.isSkinnedMesh&&Ne.skinning===!1||!$.isSkinnedMesh&&Ne.skinning===!0||$.isInstancedMesh&&Ne.instancingColor===!0&&$.instanceColor===null||$.isInstancedMesh&&Ne.instancingColor===!1&&$.instanceColor!==null||Ne.envMap!==we||O.fog===!0&&Ne.fog!==fe||Ne.numClippingPlanes!==void 0&&(Ne.numClippingPlanes!==me.numPlanes||Ne.numIntersection!==me.numIntersection)||Ne.vertexAlphas!==Ie||Ne.vertexTangents!==Ee||Ne.morphTargets!==Ce||Ne.morphNormals!==rt||Ne.morphColors!==ot||Ne.toneMapping!==cn||Re.isWebGL2===!0&&Ne.morphTargetsCount!==ut)&&(ct=!0):(ct=!0,Ne.__version=O.version);let Vi=Ne.currentProgram;ct===!0&&(Vi=Ro(O,I,$));let Nf=!1,ys=!1,xl=!1;const Ot=Vi.getUniforms(),Wi=Ne.uniforms;if(Ae.useProgram(Vi.program)&&(Nf=!0,ys=!0,xl=!0),O.id!==b&&(b=O.id,ys=!0),Nf||M!==E){Ot.setValue(F,"projectionMatrix",E.projectionMatrix),Ot.setValue(F,"viewMatrix",E.matrixWorldInverse);const en=Ot.map.cameraPosition;en!==void 0&&en.setValue(F,Ge.setFromMatrixPosition(E.matrixWorld)),Re.logarithmicDepthBuffer&&Ot.setValue(F,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),(O.isMeshPhongMaterial||O.isMeshToonMaterial||O.isMeshLambertMaterial||O.isMeshBasicMaterial||O.isMeshStandardMaterial||O.isShaderMaterial)&&Ot.setValue(F,"isOrthographic",E.isOrthographicCamera===!0),M!==E&&(M=E,ys=!0,xl=!0)}if($.isSkinnedMesh){Ot.setOptional(F,$,"bindMatrix"),Ot.setOptional(F,$,"bindMatrixInverse");const en=$.skeleton;en&&(Re.floatVertexTextures?(en.boneTexture===null&&en.computeBoneTexture(),Ot.setValue(F,"boneTexture",en.boneTexture,be),Ot.setValue(F,"boneTextureSize",en.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const Sl=q.morphAttributes;if((Sl.position!==void 0||Sl.normal!==void 0||Sl.color!==void 0&&Re.isWebGL2===!0)&&ve.update($,q,Vi),(ys||Ne.receiveShadow!==$.receiveShadow)&&(Ne.receiveShadow=$.receiveShadow,Ot.setValue(F,"receiveShadow",$.receiveShadow)),O.isMeshGouraudMaterial&&O.envMap!==null&&(Wi.envMap.value=we,Wi.flipEnvMap.value=we.isCubeTexture&&we.isRenderTargetTexture===!1?-1:1),ys&&(Ot.setValue(F,"toneMappingExposure",g.toneMappingExposure),Ne.needsLights&&g_(Wi,xl),fe&&O.fog===!0&&ee.refreshFogUniforms(Wi,fe),ee.refreshMaterialUniforms(Wi,O,B,K,pe),Ta.upload(F,Ne.uniformsList,Wi,be)),O.isShaderMaterial&&O.uniformsNeedUpdate===!0&&(Ta.upload(F,Ne.uniformsList,Wi,be),O.uniformsNeedUpdate=!1),O.isSpriteMaterial&&Ot.setValue(F,"center",$.center),Ot.setValue(F,"modelViewMatrix",$.modelViewMatrix),Ot.setValue(F,"normalMatrix",$.normalMatrix),Ot.setValue(F,"modelMatrix",$.matrixWorld),O.isShaderMaterial||O.isRawShaderMaterial){const en=O.uniformsGroups;for(let yl=0,v_=en.length;yl<v_;yl++)if(Re.isWebGL2){const Ff=en[yl];Ue.update(Ff,Vi),Ue.bind(Ff,Vi)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Vi}function g_(E,I){E.ambientLightColor.needsUpdate=I,E.lightProbe.needsUpdate=I,E.directionalLights.needsUpdate=I,E.directionalLightShadows.needsUpdate=I,E.pointLights.needsUpdate=I,E.pointLightShadows.needsUpdate=I,E.spotLights.needsUpdate=I,E.spotLightShadows.needsUpdate=I,E.rectAreaLights.needsUpdate=I,E.hemisphereLights.needsUpdate=I}function __(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return T},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return R},this.setRenderTargetTextures=function(E,I,q){Oe.get(E.texture).__webglTexture=I,Oe.get(E.depthTexture).__webglTexture=q;const O=Oe.get(E);O.__hasExternalTextures=!0,O.__hasExternalTextures&&(O.__autoAllocateDepthBuffer=q===void 0,O.__autoAllocateDepthBuffer||Me.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),O.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(E,I){const q=Oe.get(E);q.__webglFramebuffer=I,q.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(E,I=0,q=0){R=E,T=I,C=q;let O=!0,$=null,fe=!1,xe=!1;if(E){const we=Oe.get(E);we.__useDefaultFramebuffer!==void 0?(Ae.bindFramebuffer(F.FRAMEBUFFER,null),O=!1):we.__webglFramebuffer===void 0?be.setupRenderTarget(E):we.__hasExternalTextures&&be.rebindTextures(E,Oe.get(E.texture).__webglTexture,Oe.get(E.depthTexture).__webglTexture);const Ie=E.texture;(Ie.isData3DTexture||Ie.isDataArrayTexture||Ie.isCompressedArrayTexture)&&(xe=!0);const Ee=Oe.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(Array.isArray(Ee[I])?$=Ee[I][q]:$=Ee[I],fe=!0):Re.isWebGL2&&E.samples>0&&be.useMultisampledRTT(E)===!1?$=Oe.get(E).__webglMultisampledFramebuffer:Array.isArray(Ee)?$=Ee[q]:$=Ee,w.copy(E.viewport),N.copy(E.scissor),Z=E.scissorTest}else w.copy(H).multiplyScalar(B).floor(),N.copy(U).multiplyScalar(B).floor(),Z=k;if(Ae.bindFramebuffer(F.FRAMEBUFFER,$)&&Re.drawBuffers&&O&&Ae.drawBuffers(E,$),Ae.viewport(w),Ae.scissor(N),Ae.setScissorTest(Z),fe){const we=Oe.get(E.texture);F.framebufferTexture2D(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,F.TEXTURE_CUBE_MAP_POSITIVE_X+I,we.__webglTexture,q)}else if(xe){const we=Oe.get(E.texture),Ie=I||0;F.framebufferTextureLayer(F.FRAMEBUFFER,F.COLOR_ATTACHMENT0,we.__webglTexture,q||0,Ie)}b=-1},this.readRenderTargetPixels=function(E,I,q,O,$,fe,xe){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Te=Oe.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&xe!==void 0&&(Te=Te[xe]),Te){Ae.bindFramebuffer(F.FRAMEBUFFER,Te);try{const we=E.texture,Ie=we.format,Ee=we.type;if(Ie!==Dn&&de.convert(Ie)!==F.getParameter(F.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ce=Ee===mo&&(Me.has("EXT_color_buffer_half_float")||Re.isWebGL2&&Me.has("EXT_color_buffer_float"));if(Ee!==Fi&&de.convert(Ee)!==F.getParameter(F.IMPLEMENTATION_COLOR_READ_TYPE)&&!(Ee===wi&&(Re.isWebGL2||Me.has("OES_texture_float")||Me.has("WEBGL_color_buffer_float")))&&!Ce){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=E.width-O&&q>=0&&q<=E.height-$&&F.readPixels(I,q,O,$,de.convert(Ie),de.convert(Ee),fe)}finally{const we=R!==null?Oe.get(R).__webglFramebuffer:null;Ae.bindFramebuffer(F.FRAMEBUFFER,we)}}},this.copyFramebufferToTexture=function(E,I,q=0){const O=Math.pow(2,-q),$=Math.floor(I.image.width*O),fe=Math.floor(I.image.height*O);be.setTexture2D(I,0),F.copyTexSubImage2D(F.TEXTURE_2D,q,0,0,E.x,E.y,$,fe),Ae.unbindTexture()},this.copyTextureToTexture=function(E,I,q,O=0){const $=I.image.width,fe=I.image.height,xe=de.convert(q.format),Te=de.convert(q.type);be.setTexture2D(q,0),F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,q.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,q.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,q.unpackAlignment),I.isDataTexture?F.texSubImage2D(F.TEXTURE_2D,O,E.x,E.y,$,fe,xe,Te,I.image.data):I.isCompressedTexture?F.compressedTexSubImage2D(F.TEXTURE_2D,O,E.x,E.y,I.mipmaps[0].width,I.mipmaps[0].height,xe,I.mipmaps[0].data):F.texSubImage2D(F.TEXTURE_2D,O,E.x,E.y,xe,Te,I.image),O===0&&q.generateMipmaps&&F.generateMipmap(F.TEXTURE_2D),Ae.unbindTexture()},this.copyTextureToTexture3D=function(E,I,q,O,$=0){if(g.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const fe=E.max.x-E.min.x+1,xe=E.max.y-E.min.y+1,Te=E.max.z-E.min.z+1,we=de.convert(O.format),Ie=de.convert(O.type);let Ee;if(O.isData3DTexture)be.setTexture3D(O,0),Ee=F.TEXTURE_3D;else if(O.isDataArrayTexture)be.setTexture2DArray(O,0),Ee=F.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}F.pixelStorei(F.UNPACK_FLIP_Y_WEBGL,O.flipY),F.pixelStorei(F.UNPACK_PREMULTIPLY_ALPHA_WEBGL,O.premultiplyAlpha),F.pixelStorei(F.UNPACK_ALIGNMENT,O.unpackAlignment);const Ce=F.getParameter(F.UNPACK_ROW_LENGTH),rt=F.getParameter(F.UNPACK_IMAGE_HEIGHT),ot=F.getParameter(F.UNPACK_SKIP_PIXELS),cn=F.getParameter(F.UNPACK_SKIP_ROWS),Xn=F.getParameter(F.UNPACK_SKIP_IMAGES),ut=q.isCompressedTexture?q.mipmaps[0]:q.image;F.pixelStorei(F.UNPACK_ROW_LENGTH,ut.width),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,ut.height),F.pixelStorei(F.UNPACK_SKIP_PIXELS,E.min.x),F.pixelStorei(F.UNPACK_SKIP_ROWS,E.min.y),F.pixelStorei(F.UNPACK_SKIP_IMAGES,E.min.z),q.isDataTexture||q.isData3DTexture?F.texSubImage3D(Ee,$,I.x,I.y,I.z,fe,xe,Te,we,Ie,ut.data):q.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),F.compressedTexSubImage3D(Ee,$,I.x,I.y,I.z,fe,xe,Te,we,ut.data)):F.texSubImage3D(Ee,$,I.x,I.y,I.z,fe,xe,Te,we,Ie,ut),F.pixelStorei(F.UNPACK_ROW_LENGTH,Ce),F.pixelStorei(F.UNPACK_IMAGE_HEIGHT,rt),F.pixelStorei(F.UNPACK_SKIP_PIXELS,ot),F.pixelStorei(F.UNPACK_SKIP_ROWS,cn),F.pixelStorei(F.UNPACK_SKIP_IMAGES,Xn),$===0&&O.generateMipmaps&&F.generateMipmap(Ee),Ae.unbindTexture()},this.initTexture=function(E){E.isCubeTexture?be.setTextureCube(E,0):E.isData3DTexture?be.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?be.setTexture2DArray(E,0):be.setTexture2D(E,0),Ae.unbindTexture()},this.resetState=function(){T=0,C=0,R=null,Ae.reset(),he.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ri}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(e){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!e}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===Ze?ar:jg}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===ar?Ze:Wn}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class ZT extends d_{}ZT.prototype.isWebGL1Renderer=!0;class QT extends It{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n}}class up extends Jt{constructor(e,n,i,r,s,o,a,l,u){super(e,n,i,r,s,o,a,l,u),this.isCanvasTexture=!0,this.needsUpdate=!0}}class JT extends To{constructor(e){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new We(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new We(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Yg,this.normalScale=new He(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.defines={STANDARD:""},this.color.copy(e.color),this.roughness=e.roughness,this.metalness=e.metalness,this.map=e.map,this.lightMap=e.lightMap,this.lightMapIntensity=e.lightMapIntensity,this.aoMap=e.aoMap,this.aoMapIntensity=e.aoMapIntensity,this.emissive.copy(e.emissive),this.emissiveMap=e.emissiveMap,this.emissiveIntensity=e.emissiveIntensity,this.bumpMap=e.bumpMap,this.bumpScale=e.bumpScale,this.normalMap=e.normalMap,this.normalMapType=e.normalMapType,this.normalScale.copy(e.normalScale),this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.roughnessMap=e.roughnessMap,this.metalnessMap=e.metalnessMap,this.alphaMap=e.alphaMap,this.envMap=e.envMap,this.envMapIntensity=e.envMapIntensity,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this.wireframeLinecap=e.wireframeLinecap,this.wireframeLinejoin=e.wireframeLinejoin,this.flatShading=e.flatShading,this.fog=e.fog,this}}class h_ extends It{constructor(e,n=1){super(),this.isLight=!0,this.type="Light",this.color=new We(e),this.intensity=n}dispose(){}copy(e,n){return super.copy(e,n),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const n=super.toJSON(e);return n.object.color=this.color.getHex(),n.object.intensity=this.intensity,this.groundColor!==void 0&&(n.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(n.object.distance=this.distance),this.angle!==void 0&&(n.object.angle=this.angle),this.decay!==void 0&&(n.object.decay=this.decay),this.penumbra!==void 0&&(n.object.penumbra=this.penumbra),this.shadow!==void 0&&(n.object.shadow=this.shadow.toJSON()),n}}const Tu=new gt,cp=new V,fp=new V;class e1{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new He(512,512),this.map=null,this.mapPass=null,this.matrix=new gt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Rf,this._frameExtents=new He(1,1),this._viewportCount=1,this._viewports=[new yt(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const n=this.camera,i=this.matrix;cp.setFromMatrixPosition(e.matrixWorld),n.position.copy(cp),fp.setFromMatrixPosition(e.target.matrixWorld),n.lookAt(fp),n.updateMatrixWorld(),Tu.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Tu),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Tu)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class t1 extends e1{constructor(){super(new a_(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class n1 extends h_{constructor(e,n){super(e,n),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(It.DEFAULT_UP),this.updateMatrix(),this.target=new It,this.shadow=new t1}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class i1 extends h_{constructor(e,n){super(e,n),this.isAmbientLight=!0,this.type="AmbientLight"}}class r1{constructor(e,n,i=0,r=1/0){this.ray=new Qg(e,n),this.near=i,this.far=r,this.camera=null,this.layers=new Af,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(e,n){this.ray.set(e,n)}setFromCamera(e,n){n.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(n.matrixWorld),this.ray.direction.set(e.x,e.y,.5).unproject(n).sub(this.ray.origin).normalize(),this.camera=n):n.isOrthographicCamera?(this.ray.origin.set(e.x,e.y,(n.near+n.far)/(n.near-n.far)).unproject(n),this.ray.direction.set(0,0,-1).transformDirection(n.matrixWorld),this.camera=n):console.error("THREE.Raycaster: Unsupported camera type: "+n.type)}intersectObject(e,n=!0,i=[]){return Rc(e,this,i,n),i.sort(dp),i}intersectObjects(e,n=!0,i=[]){for(let r=0,s=e.length;r<s;r++)Rc(e[r],this,i,n);return i.sort(dp),i}}function dp(t,e){return t.distance-e.distance}function Rc(t,e,n,i){if(t.layers.test(e.layers)&&t.raycast(e,n),i===!0){const r=t.children;for(let s=0,o=r.length;s<o;s++)Rc(r[s],e,n,!0)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Ef}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Ef);function Lf(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function hp(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}function Pf(t,e,n){return e&&hp(t.prototype,e),n&&hp(t,n),t}function pp(t){return+t.replace(/px/,"")}function s1(t){var e=window.devicePixelRatio,n=getComputedStyle(t),i=pp(n.getPropertyValue("width")),r=pp(n.getPropertyValue("height"));t.setAttribute("width",(i*e).toString()),t.setAttribute("height",(r*e).toString())}function An(t,e){var n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:0,i=Math.random()*(e-t)+t;return Math.floor(i*Math.pow(10,n))/Math.pow(10,n)}function mp(t){return t[An(0,t.length)]}var o1=.00125,a1=5e-4,l1=9e-4,u1=1e-5,c1=6,f1=80,d1=.9,h1=1.7,p1=.2,m1=.6,g1=.03,_1=.07,gp=15,_p=82,v1=150,x1=100,S1=250,y1=40,M1=["#fcf403","#62fc03","#f4fc03","#03e7fc","#03fca5","#a503fc","#fc03ad","#fc03c2"];function vp(t){var e=1920;return Math.log(t)/Math.log(e)}var xp=function(){function t(e){Lf(this,t);var n=e.initialPosition,i=e.direction,r=e.confettiRadius,s=e.confettiColors,o=e.emojis,a=e.emojiSize,l=e.canvasWidth,u=An(d1,h1,3),f=u*vp(l);this.confettiSpeed={x:f,y:f},this.finalConfettiSpeedX=An(p1,m1,3),this.rotationSpeed=o.length?.01:An(g1,_1,3)*vp(l),this.dragForceCoefficient=An(a1,l1,6),this.radius={x:r,y:r},this.initialRadius=r,this.rotationAngle=i==="left"?An(0,.2,3):An(-.2,0,3),this.emojiSize=a,this.emojiRotationAngle=An(0,2*Math.PI),this.radiusYUpdateDirection="down";var h=i==="left"?An(_p,gp)*Math.PI/180:An(-gp,-_p)*Math.PI/180;this.absCos=Math.abs(Math.cos(h)),this.absSin=Math.abs(Math.sin(h));var d=An(-v1,0),m={x:n.x+(i==="left"?-d:d)*this.absCos,y:n.y-d*this.absSin};this.currentPosition=Object.assign({},m),this.initialPosition=Object.assign({},m),this.color=o.length?null:mp(s),this.emoji=o.length?mp(o):null,this.createdAt=new Date().getTime(),this.direction=i}return Pf(t,[{key:"draw",value:function(n){var i=this.currentPosition,r=this.radius,s=this.color,o=this.emoji,a=this.rotationAngle,l=this.emojiRotationAngle,u=this.emojiSize,f=window.devicePixelRatio;s?(n.fillStyle=s,n.beginPath(),n.ellipse(i.x*f,i.y*f,r.x*f,r.y*f,a,0,2*Math.PI),n.fill()):o&&(n.font="".concat(u,"px serif"),n.save(),n.translate(f*i.x,f*i.y),n.rotate(l),n.textAlign="center",n.fillText(o,0,0),n.restore())}},{key:"updatePosition",value:function(n,i){var r=this.confettiSpeed,s=this.dragForceCoefficient,o=this.finalConfettiSpeedX,a=this.radiusYUpdateDirection,l=this.rotationSpeed,u=this.createdAt,f=this.direction,h=i-u;if(r.x>o&&(this.confettiSpeed.x-=s*n),this.currentPosition.x+=r.x*(f==="left"?-this.absCos:this.absCos)*n,this.currentPosition.y=this.initialPosition.y-r.y*this.absSin*h+o1*Math.pow(h,2)/2,this.rotationSpeed-=this.emoji?1e-4:u1*n,this.rotationSpeed<0&&(this.rotationSpeed=0),this.emoji){this.emojiRotationAngle+=this.rotationSpeed*n%(2*Math.PI);return}a==="down"?(this.radius.y-=n*l,this.radius.y<=0&&(this.radius.y=0,this.radiusYUpdateDirection="up")):(this.radius.y+=n*l,this.radius.y>=this.initialRadius&&(this.radius.y=this.initialRadius,this.radiusYUpdateDirection="down"))}},{key:"getIsVisibleOnCanvas",value:function(n){return this.currentPosition.y<n+x1}}]),t}();function E1(){var t=document.createElement("canvas");return t.style.position="fixed",t.style.width="100%",t.style.height="100%",t.style.top="0",t.style.left="0",t.style.zIndex="1000",t.style.pointerEvents="none",document.body.appendChild(t),t}function T1(t){var e=t.confettiRadius,n=e===void 0?c1:e,i=t.confettiNumber,r=i===void 0?t.confettiesNumber||(t.emojis?y1:S1):i,s=t.confettiColors,o=s===void 0?M1:s,a=t.emojis,l=a===void 0?t.emojies||[]:a,u=t.emojiSize,f=u===void 0?f1:u;return t.emojies&&console.error("emojies argument is deprecated, please use emojis instead"),t.confettiesNumber&&console.error("confettiesNumber argument is deprecated, please use confettiNumber instead"),{confettiRadius:n,confettiNumber:r,confettiColors:o,emojis:l,emojiSize:f}}var w1=function(){function t(e){var n=this;Lf(this,t),this.canvasContext=e,this.shapes=[],this.promise=new Promise(function(i){return n.resolvePromise=i})}return Pf(t,[{key:"getBatchCompletePromise",value:function(){return this.promise}},{key:"addShapes",value:function(){var n;(n=this.shapes).push.apply(n,arguments)}},{key:"complete",value:function(){var n;return this.shapes.length?!1:((n=this.resolvePromise)===null||n===void 0||n.call(this),!0)}},{key:"processShapes",value:function(n,i,r){var s=this,o=n.timeDelta,a=n.currentTime;this.shapes=this.shapes.filter(function(l){return l.updatePosition(o,a),l.draw(s.canvasContext),r?l.getIsVisibleOnCanvas(i):!0})}}]),t}(),A1=function(){function t(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};Lf(this,t),this.activeConfettiBatches=[],this.canvas=e.canvas||E1(),this.canvasContext=this.canvas.getContext("2d"),this.requestAnimationFrameRequested=!1,this.lastUpdated=new Date().getTime(),this.iterationIndex=0,this.loop=this.loop.bind(this),requestAnimationFrame(this.loop)}return Pf(t,[{key:"loop",value:function(){this.requestAnimationFrameRequested=!1,s1(this.canvas);var n=new Date().getTime(),i=n-this.lastUpdated,r=this.canvas.offsetHeight,s=this.iterationIndex%10===0;this.activeConfettiBatches=this.activeConfettiBatches.filter(function(o){return o.processShapes({timeDelta:i,currentTime:n},r,s),s?!o.complete():!0}),this.iterationIndex++,this.queueAnimationFrameIfNeeded(n)}},{key:"queueAnimationFrameIfNeeded",value:function(n){this.requestAnimationFrameRequested||this.activeConfettiBatches.length<1||(this.requestAnimationFrameRequested=!0,this.lastUpdated=n||new Date().getTime(),requestAnimationFrame(this.loop))}},{key:"addConfetti",value:function(){for(var n=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},i=T1(n),r=i.confettiRadius,s=i.confettiNumber,o=i.confettiColors,a=i.emojis,l=i.emojiSize,u=this.canvas.getBoundingClientRect(),f=u.width,h=u.height,d=h*5/7,m={x:0,y:d},x={x:f,y:d},v=new w1(this.canvasContext),p=0;p<s/2;p++){var c=new xp({initialPosition:m,direction:"right",confettiRadius:r,confettiColors:o,confettiNumber:s,emojis:a,emojiSize:l,canvasWidth:f}),_=new xp({initialPosition:x,direction:"left",confettiRadius:r,confettiColors:o,confettiNumber:s,emojis:a,emojiSize:l,canvasWidth:f});v.addShapes(c,_)}return this.activeConfettiBatches.push(v),this.queueAnimationFrameIfNeeded(),v.getBatchCompletePromise()}},{key:"clearCanvas",value:function(){this.activeConfettiBatches=[]}}]),t}();const R1=t=>{const e=Array.from({length:100}).fill().map((n,i)=>i);return Array.from({length:18}).fill().map((n,i)=>{const r=Math.floor(Math.random()*e.length),s=e.splice(r,1)[0];return s===new Date().getDate()&&i>12&&Math.random()>.5?s-1:s!==t||s===t&&t===r?s:e.pop()||0})},C1=t=>{const e=76.92307692307692,n=280/3.64;return{x:t.x*n+140,y:t.y*e+256}},L1=(t,e)=>e.map((n,i)=>n===t||n===new Date().getDate()?i:null).filter(n=>n!==null),Sp=[5,10,15,20,30,40,50,100,150,200,250,300,400,500,600,700,800,999];function P1(){const t=Be.useRef(),e=Be.useRef(null),n=Be.useRef(!1),i=Be.useRef(new He),r=Be.useRef([]),s=Be.useRef(Math.floor(Math.random()*100)),o=Be.useRef(R1(s.current)),a=Be.useRef(L1(s.current,o.current)),l=Be.useMemo(()=>new QT,[]),u=Be.useMemo(()=>new gn(75,window.innerWidth/(window.innerHeight*.8),.1,1e3),[]),f=Be.useMemo(()=>new d_({antialias:!0}),[]),h=Be.useMemo(()=>new i1(0),[]),d=Be.useMemo(()=>new n1(16777215,2.4),[]),m=Be.useMemo(()=>{const N=new Image(280,512);return N.src="textures/bg.png",N},[]),x=Be.useMemo(()=>{const N=document.createElement("canvas");return N.width=280,N.height=512,N},[]),v=Be.useMemo(()=>{const N=document.createElement("canvas");return N.width=280,N.height=512,N},[]),p=Be.useMemo(()=>{const N=document.createElement("canvas");return N.width=280,N.height=512,N},[]),c=Be.useMemo(()=>new JT({color:16777215,roughness:.42}),[]),_=Be.useMemo(()=>new gl(3.64,6.656),[]),g=Be.useCallback(()=>{const N=v.getContext("2d"),Z=p.getContext("2d"),D=r.current.length;r.current.slice(Math.max(0,D-10),D).forEach(z=>{const W=C1(z);N.clearRect(W.x,W.y,20,20);const K=a.current.findIndex(B=>{const P=34+Math.trunc(B%6)*38,X=312+Math.trunc(B/6)*48;if(W.x>=P-20&&W.x<=P+20&&W.y>=X-20&&W.y<=X+20)return new A1().addConfetti({confettiRadius:4,confettiNumber:256}),!0});K!==-1&&a.current.splice(K,1)}),Z.drawImage(x,0,0),Z.drawImage(v,0,0),c.map=new up(p),c.needsUpdate=!0},[x,v,p,c]),S=Be.useMemo(()=>{const N=x.getContext("2d"),Z=v.getContext("2d"),D=p.getContext("2d");m.onload=()=>{N.globalCompositeOperation="source-over",N.drawImage(m,0,0,280,512),Z.fillStyle="#ccc",Z.beginPath(),Z.arc(227.5,238,28,0,2*Math.PI,!1),Z.fill(),Z.beginPath(),Z.roundRect(20,287.5,240,150,4),Z.fill();const W=new Date().getDate();N.fillStyle="white",N.font="36px sans",N.fillText(W.toString().padStart(2,"0"),31,252),N.fillStyle="white",N.font="36px sans",N.fillText(s.current.toString().padStart(2,"0"),206,252),o.current.forEach((K,B)=>{const P=34+Math.trunc(B%6)*38,X=312+Math.trunc(B/6)*48;N.fillStyle=K===s.current||K===W?"#ffcc16":"white",N.font="16px sans",N.fillText(K.toString().padStart(2,"0"),P,X),N.fillStyle=K===s.current||K===W?"#ffcc16":"white",N.font="12px sans",N.fillText(`￥${Sp[B]}`,P-N.measureText(`￥${Sp[B]}`).width/4,X+16)}),D.drawImage(x,0,0),D.drawImage(v,0,0),c.map=new up(p),c.needsUpdate=!0};const z=new si(_,c);return z.name="card",z},[_,c,g]),[T,C]=Be.useState({x:0,y:0}),[R,b]=Be.useState(!1),M=()=>b(!1);Be.useEffect(()=>{const N=()=>{u.aspect=window.innerWidth/(window.innerHeight*.8),u.updateProjectionMatrix(),f.setPixelRatio(window.devicePixelRatio),f.setSize(window.innerWidth,window.innerHeight*.8),f.setClearColor(0,0),t.current.children.length===0&&t.current.appendChild(f.domElement)};return N(),window.addEventListener("resize",N),()=>{window.removeEventListener("resize",N)}},[f,u]),Be.useEffect(()=>{l.add(S),l.add(h),d.position.set(-.5,1.2,2),l.add(d),u.position.z=5},[l,u,h,S,d]),Be.useEffect(()=>{const N=()=>{e.current=requestAnimationFrame(N);const Z=Math.PI/16*Math.max(-1,Math.min(1,T.x)),D=Math.PI/36*Math.max(-1,Math.min(1,T.y));S.rotation.x+=(D-S.rotation.x)*.1,S.rotation.y+=(Z-S.rotation.y)*.04;const z=new V(i.current.x,i.current.y,.5).unproject(u),K=new r1(u.position,z.sub(u.position).normalize()).intersectObjects(l.children);K.length>0&&n.current&&K.find(({object:B})=>B.name==="card")&&(r.current.push(K[0].point),g()),f.render(l,u)};return N(),()=>{e.current!==null&&cancelAnimationFrame(e.current)}},[l,u,T,c,S,g]),Be.useEffect(()=>{const N=z=>{C({x:z.clientX/window.innerWidth*2-1,y:z.clientY/(window.innerHeight*.8)*2-1})},Z=z=>{C({x:z.changedTouches[0].clientX/window.innerWidth*2-1,y:z.changedTouches[0].clientY/(window.innerHeight*.8)*2-1})},D=()=>C({x:0,y:0});return t.current.addEventListener("mousemove",N),t.current.addEventListener("mouseup",D),t.current.addEventListener("mouseleave",D),t.current.addEventListener("touchmove",Z),t.current.addEventListener("touchend",D),t.current.addEventListener("touchcancel",D),()=>{t.current.removeEventListener("mousemove",N),t.current.removeEventListener("mouseup",D),t.current.removeEventListener("mouseleave",D),t.current.removeEventListener("touchmove",Z),t.current.removeEventListener("touchend",D),t.current.removeEventListener("touchcancel",D)}},[]),Be.useEffect(()=>{const N=B=>{i.current.x=B.clientX/window.innerWidth*2-1,i.current.y=B.clientY/(window.innerHeight*.8)*2-1},Z=B=>{n.current=!0,N(B)},D=B=>{n.current=!1,N(B)},z=B=>{i.current.x=B.changedTouches[0].clientX/window.innerWidth*2-1,i.current.y=B.changedTouches[0].clientY/(window.innerHeight*.8)*2-1},W=B=>{n.current=!0,z(B)},K=B=>{n.current=!1,z(B)};return t.current.addEventListener("mousedown",Z),t.current.addEventListener("mousemove",N),t.current.addEventListener("mouseup",D),t.current.addEventListener("mouseleave",D),t.current.addEventListener("touchstart",W),t.current.addEventListener("touchmove",z),t.current.addEventListener("touchend",K),t.current.addEventListener("touchcancel",K),()=>{t.current.removeEventListener("mousedown",Z),t.current.removeEventListener("mousemove",N),t.current.removeEventListener("mouseup",D),t.current.removeEventListener("mouseleave",D),t.current.removeEventListener("touchstart",W),t.current.removeEventListener("touchmove",z),t.current.removeEventListener("touchend",K),t.current.removeEventListener("touchcancel",K)}},[]);const w=dn.jsxs("div",{className:"modal","data-visible":`${R}`,onClick:M,children:[dn.jsx("p",{children:"我还年轻，不想踩缝纫机"}),dn.jsx("p",{children:"你领个红包吧👀"}),dn.jsx("img",{src:"/qrcode.jpg"}),dn.jsx("p",{children:"点击任意处关闭"})]});return dn.jsxs("div",{className:"main",children:[dn.jsx("div",{className:"container",ref:t}),dn.jsxs("div",{className:"menu",children:[dn.jsx("button",{className:"button",onClick:()=>location.reload(),children:"再刮一张"}),dn.jsx("div",{className:"scan"})]}),Ig.createPortal(w,document.body)]})}wu.createRoot(document.getElementById("root")).render(dn.jsx(N_.StrictMode,{children:dn.jsx(P1,{})}));
